...
此类仅由 ONLYOFFICE Document Builder 用于获取所调用 JS 命令的结果。它表示 JS 对象的包装器。
...
| [Clear](Clear.md)                     | 清除对象。                                            |
| [CreateNull](CreateNull.md)           | 创建一个空值。                                        |
| [CreateUndefined](CreateUndefined.md) | 创建一个未定义值。                                    |
...
| [IsNull](IsNull.md)                   | 如果此对象是空值，则返回 true。                       |
...
| [IsUndefined](IsUndefined.md)         | 如果此对象是未定义值，则返回 true。                   |
