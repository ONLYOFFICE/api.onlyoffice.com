...
如果需要手动添加该插件，请从 [ONLYOFFICE 应用目录](https://www.onlyoffice.com/app-directory/en/ai) 下载插件，并按照 [桌面版](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md)、[本地部署版](/docs/plugins/development-workflow/installing-and-testing/docs-on-premises-installation.md) 或 [云版](/docs/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md) 的安装说明进行安装。
