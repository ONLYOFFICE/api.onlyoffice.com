...
1. *[`AnnotateParagraph`](/docs/plugins/interacting-with-editors/document-api/Methods/AnnotateParagraph)* — 向指定段落添加注释。
2. *[`SelectAnnotationRange`](/docs/plugins/interacting-with-editors/document-api/Methods/SelectAnnotationRange)* — 使用指定注释在文档中选择文本。
3. *[`RemoveAnnotationRange`](/docs/plugins/interacting-with-editors/document-api/Methods/RemoveAnnotationRange)* — 从文档中删除特定注释范围。
...
段落文本可通过订阅 [`onParagraphText`](/docs/plugins/interacting-with-editors/document-api/Events/onParagraphText) 事件来获取。
...
要在文档中显示这些结果，请使用 [`AnnotateParagraph`](/docs/plugins/interacting-with-editors/document-api/Methods/AnnotateParagraph) 方法。
...
1. [`onBlurAnnotation`](/docs/plugins/interacting-with-editors/document-api/Events/onBlurAnnotation) — 当注释失去焦点时触发。
2. [`onClickAnnotation`](/docs/plugins/interacting-with-editors/document-api/Events/onClickAnnotation) — 当用户点击注释时触发。
3. [`onFocusAnnotation`](/docs/plugins/interacting-with-editors/document-api/Events/onFocusAnnotation) — 当注释获得焦点时触发。
