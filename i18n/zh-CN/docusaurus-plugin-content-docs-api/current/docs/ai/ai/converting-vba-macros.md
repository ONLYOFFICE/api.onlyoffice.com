...
- [手动转换](#manual-conversion-of-vba-macros) — 使用 [ONLYOFFICE Office API](/docs/office-api/get-started/overview) 以 JavaScript 重写逻辑。
...
1. 配置 AI 插件。详情请参见 [配置 AI 插件](/docs/ai/ai/ai-plugin.md#configuring)。
2. 打开 **视图** 选项卡，点击 **宏**。
...
1. 分析原始 VBA 宏的逻辑。
2. 在 [ONLYOFFICE Office API](/docs/office-api/get-started/overview) 中查找等效的方法和事件。
3. 用 JavaScript 重写宏。
