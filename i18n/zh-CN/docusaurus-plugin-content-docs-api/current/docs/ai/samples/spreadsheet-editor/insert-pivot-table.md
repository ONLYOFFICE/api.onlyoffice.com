...
此函数将数据透视表插入到指定范围或当前选定范围。
此函数可用于按行和值对数据进行汇总、分组或聚合。

## 提示词

- 插入数据透视表
- 使用数据透视表按 Column1 和 Column2 对数据进行分组
- 在数据透视表中按 Column3 聚合数据
...
| ----------- | ---------------- | ---------------------- | ----------------------------------------------------------------------------------------- |
| range       | string           | "A1:D10"               | 数据透视表数据的单元格范围。如果省略，则使用活动或选定范围。                               |
| columns     | string[] | ["Column1", "Column2"] | 用于数据透视表行的列名数组（分类/分组列）。                                                |
| valueColumn | string           | "Column3"              | 用于数据透视表数值的列名（数值/聚合列）。                                                  |
