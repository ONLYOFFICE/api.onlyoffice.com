...
| criteria1       | string \| array \| object | ">18"            | 筛选条件。可以是：用于运算符的字符串（如 ">10"）、用于多个值的数组（如 \[1,2,3]）、用于颜色筛选的 [ApiColor](../../../../../../../../site/docs/office-api/usage-api/spreadsheet-api/ApiColor/ApiColor.md) 对象，或动态筛选常量。 |
