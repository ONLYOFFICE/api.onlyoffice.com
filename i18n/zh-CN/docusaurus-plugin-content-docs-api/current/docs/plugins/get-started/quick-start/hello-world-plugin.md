...
[桌面版安装详细指南](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation)
...
[Docs 安装详细指南](/docs/plugins/development-workflow/installing-and-testing/docs-on-premises-installation)
...
- [插件结构与配置](/docs/plugins/fundamentals/configuration/config-json)
- [完整 API 参考](/docs/plugins/interacting-with-editors/overview/)
- [UI 自定义选项](/docs/plugins/customization/toolbar)

**浏览示例：**

- [YouTube 插件](/docs/plugins/samples/plugins/youtube) — 嵌入视频
- [Translator 插件](/docs/plugins/samples/plugins/translator) — 多语言支持
