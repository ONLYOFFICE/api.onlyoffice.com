...
插件类型通过 *config.json* 文件中的 [type](config-json.md#variationstype) 参数指定。可用值包括 **system**、**background**、**window**、**panel**、**panelRight** 和 **unvisible**。

## system

系统插件不会显示在编辑器界面中，它随服务器启动（或桌面编辑器启动）在后台运行，且不会干扰其他插件，使它们能同时工作。此类插件无需用户手动启动。与后台插件不同，系统插件无法被禁用。

**示例**: [Settings](../../learning-resources/samples-and-examples/plugin-samples/settings.md)、[Search and replace on start](../../learning-resources/samples-and-examples/plugin-samples/search-and-replace-on-start.md)
...
**示例**: [Highlight code](../../learning-resources/samples-and-examples/plugin-samples/highlight-code.md)、[Photo editor](../../learning-resources/samples-and-examples/plugin-samples/photo-editor.md)、[OCR](../../learning-resources/samples-and-examples/plugin-samples/ocr.md)
...
**示例**: [Translator](../../learning-resources/samples-and-examples/plugin-samples/translator.md)、[Thesaurus](../../learning-resources/samples-and-examples/plugin-samples/thesaurus.md)、[Zotero](../../learning-resources/samples-and-examples/plugin-samples/zotero.md)
...
**示例**: [Hello world](../../learning-resources/samples-and-examples/plugin-samples/hello-world.md)、[Speech](../../learning-resources/samples-and-examples/plugin-samples/speech.md)
