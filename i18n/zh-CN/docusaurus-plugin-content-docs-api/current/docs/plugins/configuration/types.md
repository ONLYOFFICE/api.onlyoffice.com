...
**示例**: [Settings](../samples/settings.md)、[Search and replace on start](../samples/search-and-replace-on-start.md)
...
**示例**: [Highlight code](../samples/highlight-code.md)、[Photo editor](../samples/photo-editor.md)、[OCR](../samples/ocr.md)
...
**示例**: [Hello world](../samples/hello-world.md)、[Speech](../samples/speech.md)
