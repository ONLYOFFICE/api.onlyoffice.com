...
你也可以按照以下安装说明移除它：[桌面版安装教程](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation), [私有部署安装教程](/docs/plugins/development-workflow/installing-and-testing/docs-on-premises-installation), [云端安装教程](/docs/plugins/development-workflow/installing-and-testing/cloud-saas-installation)。
