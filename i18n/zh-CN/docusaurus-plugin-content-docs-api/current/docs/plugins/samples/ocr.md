...
可根据以下说明将其移除：[桌面端](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation)、[本地部署](/docs/plugins/development-workflow/installing-and-testing/docs-on-premises-installation)、[云端](/docs/plugins/development-workflow/installing-and-testing/cloud-saas-installation)。
...
- init
- onTranslate
- [resizeWindow](/docs/plugins/customization/windows-and-panels#interacting-with-a-window)
- [info.recalculate](/docs/plugins/interacting-with-editors/overview/how-to-call-commands#recalculate)
