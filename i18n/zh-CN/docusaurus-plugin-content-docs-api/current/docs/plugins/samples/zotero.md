...
您也可以从 [ONLYOFFICE 应用目录](https://www.onlyoffice.com/app-directory/zh/zotero)下载该插件，并根据[桌面](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation)安装说明进行安装。
