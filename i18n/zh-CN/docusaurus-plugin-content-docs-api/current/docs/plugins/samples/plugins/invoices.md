...
从 [GitHub](https://github.com/ONLYOFFICE/sdkjs-plugins/tree/master/invoices) 下载此插件，并根据以下说明进行安装：[桌面端安装教程](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation), [本地部署安装教程](/docs/plugins/development-workflow/installing-and-testing/docs-on-premises-installation), [云端安装教程](/docs/plugins/development-workflow/installing-and-testing/cloud-saas-installation)。
