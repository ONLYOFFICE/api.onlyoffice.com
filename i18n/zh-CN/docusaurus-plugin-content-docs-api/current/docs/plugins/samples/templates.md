...
从 [GitHub](https://github.com/ONLYOFFICE/sdkjs-plugins/tree/master/templates) 下载该插件，并根据以下说明进行安装：[桌面版](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation)、[本地部署版](/docs/plugins/development-workflow/installing-and-testing/docs-on-premises-installation)或[云端版](/docs/plugins/development-workflow/installing-and-testing/cloud-saas-installation)。
