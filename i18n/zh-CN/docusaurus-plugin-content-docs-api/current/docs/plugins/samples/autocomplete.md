...
从 [ONLYOFFICE 应用目录](https://www.onlyoffice.com/app-directory/zh/autocomplete)下载此插件，并按照[桌面版](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation)，[本地部署版](/docs/plugins/development-workflow/installing-and-testing/docs-on-premises-installation)或者[云端版](/docs/plugins/development-workflow/installing-and-testing/cloud-saas-installation)的安装说明进行安装。
