...
| [InsertAndReplaceContentControls](./InsertAndReplaceContentControls.md) | [ContentControlProperties](../Enumeration/ContentControlProperties.md)[] | 插入包含数据的内容控件。数据由 [Document](../../../../office-api/usage-api/document-api/) 的 JS 代码指定，或通过共享文档的链接指定。 |
