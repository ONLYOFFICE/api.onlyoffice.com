...
| 事件 | 描述 |
| ----- | ----------- |
| [onAddComment](./onAddComment.md) | 使用 [AddComment](../Methods/AddComment.md) 方法向文档添加评论时调用的函数。 |
| [onBlurAnnotation](./onBlurAnnotation.md) | 当批注失去焦点时调用的函数。 |
| [onBlurContentControl](./onBlurContentControl.md) | 用于显示哪个内容控件已失去焦点的函数。 |
| [onChangeCommentData](./onChangeCommentData.md) | 使用 [ChangeComment](../Methods/ChangeComment.md) 方法更改指定评论时调用的函数。 |
...
| [onRemoveComment](./onRemoveComment.md) | 使用 [RemoveComments](../Methods/RemoveComments.md) 方法删除指定评论时调用的函数。 |
