...
**ONLYOFFICE 桌面编辑器**是一款开源办公套件，用于处理存储在您计算机上的文档。此应用程序允许您创建、编辑和查看文本文档、电子表格、演示文稿、PDF 和可填写表单，无需持续连接互联网。支持大多数流行格式：DOCX、ODT、XLSX、ODS、CVS、PPTX、ODP 等。

本文档介绍：

- 如何启用[调试模式](../usage-api/debugging.md)以检测和修复所有可能的错误
...
ONLYOFFICE 桌面编辑器适用于 Windows、Linux 和 macOS。从 6.1 版本开始，此应用程序也支持基于 ARM 的 Apple Silicon Mac。
...
ONLYOFFICE 桌面编辑器 API 不断更新。要了解我们的新功能和增强功能，请访问[更新日志](../more-information/changelog.md)部分。
