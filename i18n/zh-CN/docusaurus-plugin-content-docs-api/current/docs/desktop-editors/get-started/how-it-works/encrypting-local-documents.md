...
有关插件结构的更多信息可以在[这里](/docs/plugins/fundamentals/configuration/config-json)找到。
...
所有配置参数都在[文档](/docs/plugins/fundamentals/configuration/config-json)中有描述。
...
从上面的代码可以看出，所有文件都将使用一个密码加密——*\{my-super-long-password\}*。[OnEncryption](/docs/plugins/interacting-with-editors/document-api/Methods/OnEncryption)、[StartAction](/docs/plugins/interacting-with-editors/document-api/Methods/StartAction)、[EndAction](/docs/plugins/interacting-with-editors/document-api/Methods/EndAction) 方法可以在**插件和宏 API 文档**中找到。
...
详细说明可以在[这里](/docs/plugins/development-workflow/installing-and-testing/desktop-editors-installation)找到。
