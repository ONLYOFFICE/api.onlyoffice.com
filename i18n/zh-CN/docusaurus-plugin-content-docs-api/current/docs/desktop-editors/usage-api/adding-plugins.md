...
**ONLYOFFICE 桌面编辑器** 允许开发者通过插件添加与 OOXML 格式无直接关联的特定功能。您可以使用 [ONLYOFFICE 应用目录](https://www.onlyoffice.com/app-directory/en) 中的现成插件，也可以参考我们的 [插件和宏 API 文档](../../plugins/fundamentals/getting-started/what-is-a-plugin.md) 创建自己的插件。
