...
| [SetBehavior](./Methods/SetBehavior.md) | boolean | 设置按钮控件行为。 |
...
| [SetFitBounds](./Methods/SetFitBounds.md) | boolean | 设置按钮控件适应边界。 |
| [SetIconXPos](./Methods/SetIconXPos.md) | boolean | 设置按钮控件图标的 x 位置。 |
| [SetIconYPos](./Methods/SetIconYPos.md) | boolean | 设置按钮控件图标的 y 位置。 |
| [SetImage](./Methods/SetImage.md) | boolean | 为按钮控件字段设置图像。 |
| [SetLabel](./Methods/SetLabel.md) | boolean | 为按钮控件字段设置标签。 |
| [SetLayout](./Methods/SetLayout.md) | boolean | 设置按钮控件布局类型 |
