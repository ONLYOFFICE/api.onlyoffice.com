...
| [IsComb](./Methods/IsComb.md) | boolean | 检查文本字段是否使用梳状格式。 |
...
| [SetComb](./Methods/SetComb.md) | boolean | 设置文本字段是否使用梳状格式。 |
| [SetDateFormat](./Methods/SetDateFormat.md) | boolean | 设置字段的日期格式。 |
| [SetFullName](./Methods/SetFullName.md) | boolean | 如果可能，设置新的字段名称。 |
| [SetMask](./Methods/SetMask.md) | boolean | 设置输入文本的输入掩码。 |
| [SetMultiline](./Methods/SetMultiline.md) | boolean | 设置文本字段的多行属性。 |
...
| [SetRegularExp](./Methods/SetRegularExp.md) | boolean | 设置字段的正则表达式验证字符串。 |
| [SetRequired](./Methods/SetRequired.md) | boolean | 设置字段为必填 |
| [SetScrollLongText](./Methods/SetScrollLongText.md) | boolean | 设置文本字段是否可以滚动长文本。 |
