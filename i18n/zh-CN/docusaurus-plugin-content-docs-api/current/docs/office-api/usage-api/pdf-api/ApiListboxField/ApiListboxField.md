...
| [IsMultipleSelection](./Methods/IsMultipleSelection.md) | boolean | 检查字段是否为多选。 |
...
| [SetCommitOnSelChange](./Methods/SetCommitOnSelChange.md) | boolean | 设置字段在选择更改时提交的属性。 |
| [SetFullName](./Methods/SetFullName.md) | boolean | 如果可能，设置新的字段名称。 |
| [SetMultipleSelection](./Methods/SetMultipleSelection.md) | boolean | 设置字段的多选属性。 |
