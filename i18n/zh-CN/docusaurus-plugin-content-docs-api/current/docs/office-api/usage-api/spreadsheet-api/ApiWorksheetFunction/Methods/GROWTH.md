...
| arg4 | 可选 | [ApiRange](../../ApiRange/ApiRange.md) \| [ApiName](../../ApiName/ApiName.md) \| boolean |  | 逻辑值：如果此参数设置为 **true**，则常数 *b* 正常计算；如果参数为 **false** 或省略，则 *b* 设置为 1。 |
