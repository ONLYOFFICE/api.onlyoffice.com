...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| sNameRange | 必需 | string |  | 系列名称。可以是单元格区域或普通文本。例如："'sheet 1'!$A$2:$A$5" - 必须是单个单元格、行或列，"A1:A5" - 必须是单个单元格、行或列，"Example series"。 |
| sValuesRange | 必需 | string |  | 工作表中包含系列值的单元格区域。例如："'sheet 1'!$A$2:$A$5" - 必须是单个单元格、行或列，"A1:A5" - 必须是单个单元格、行或列。 |
| sXValuesRange | 可选 | string |  | 工作表中包含系列 X 轴值的单元格区域。仅用于散点图。例如："'sheet 1'!$A$2:$A$5" - 必须是单个单元格、行或列，"A1:A5" - 必须是单个单元格、行或列。 |
