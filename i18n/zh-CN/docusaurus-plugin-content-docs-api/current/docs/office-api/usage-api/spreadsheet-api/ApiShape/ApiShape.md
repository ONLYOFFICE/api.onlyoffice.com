...
| [GetContent](./Methods/GetContent.md) | [ApiDocumentContent](../ApiDocumentContent/ApiDocumentContent.md) | 返回可以插入段落或文本运行的形状内部内容。 |
| [GetDocContent](./Methods/GetDocContent.md) | [ApiDocumentContent](../ApiDocumentContent/ApiDocumentContent.md) | 返回可以插入段落或文本运行的形状内部内容。 |
...
| [SetVerticalTextAlign](./Methods/SetVerticalTextAlign.md) | boolean | 设置可以插入段落或文本运行的形状内容的垂直对齐方式。 |
