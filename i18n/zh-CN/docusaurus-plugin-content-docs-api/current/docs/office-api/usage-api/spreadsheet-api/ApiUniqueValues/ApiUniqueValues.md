...
| 名称 | 类型 | 描述 |
| ---- | ---- | ----------- |
| DupeUnique | [XlDuplicateValues](../Enumeration/XlDuplicateValues.md) | 返回或设置指定唯一值条件格式规则是格式化重复值还是唯一值的设置。 |
...
| [GetType](./Methods/GetType.md) | [XlFormatConditionType](../Enumeration/XlFormatConditionType.md) | 返回唯一值条件格式规则的类型。 |
...
| [SetDupeUnique](./Methods/SetDupeUnique.md) | 无 | 设置指定唯一值条件格式规则是格式化重复值还是唯一值的设置。 |
