...
| arg4 | 可选 | [ApiRange](../../ApiRange/ApiRange.md) \| [ApiName](../../ApiName/ApiName.md) \| number[] |  | 要从工作日历中排除的一个或多个序列日期数字的可选区域或数组，如州假日、联邦假日和浮动假日。 |
