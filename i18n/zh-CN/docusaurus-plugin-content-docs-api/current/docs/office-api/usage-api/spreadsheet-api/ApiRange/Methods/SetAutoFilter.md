...
| Criteria1 | 可选 | string \| string[] \| [ApiColor](../../ApiColor/ApiColor.md) \| [XlDynamicFilterCriteria](../../Enumeration/XlDynamicFilterCriteria.md) |  | 条件（字符串；例如 "101"）。使用 "=" 查找空白字段，使用 "&lt;&gt;" 查找非空白字段，使用 "&gt;&lt;" 选择数据类型中的（无数据）字段。 |
