...
| 名称 | 类型 | 描述 |
| ---- | ---- | ----------- |
| ColorScaleCriteria | [ApiColorScaleCriterion](../ApiColorScaleCriterion/ApiColorScaleCriterion.md)[] | 返回定义此色阶规则的条件集合。 |
...
| [GetType](./Methods/GetType.md) | [XlFormatConditionType](../Enumeration/XlFormatConditionType.md) | 返回色阶条件格式规则的类型。 |
