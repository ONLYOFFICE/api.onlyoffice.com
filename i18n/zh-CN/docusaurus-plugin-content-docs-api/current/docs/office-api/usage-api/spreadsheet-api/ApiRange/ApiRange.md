...
| [Clear](./Methods/Clear.md) | boolean | 清除当前范围。 |
...
| [Replace](./Methods/Replace.md) | boolean | 将范围中的特定信息替换为另一个。 |
| [Resize](./Methods/Resize.md) | [ApiRange](../ApiRange/ApiRange.md) \| null | 通过更改行数和列数来调整当前范围的大小。 |
| [Select](./Methods/Select.md) | boolean | 选择当前范围。 |
...
| [SetBold](./Methods/SetBold.md) | boolean | 设置当前单元格或单元格范围中文本字符的粗体属性。 |
| [SetBorders](./Methods/SetBorders.md) | boolean | 使用指定的参数设置单元格/单元格范围的边框。 |
| [SetColumnWidth](./Methods/SetColumnWidth.md) | 无 | 设置当前范围中所有列的宽度。 |
| [SetFillColor](./Methods/SetFillColor.md) | boolean | 使用先前创建的颜色对象为当前单元格范围设置背景颜色。 |
| [SetFontColor](./Methods/SetFontColor.md) | boolean | 使用先前创建的颜色对象设置当前单元格范围的文本颜色。 |
| [SetFontName](./Methods/SetFontName.md) | boolean | 将指定的字体系列设置为当前单元格范围的字体名称。 |
...
| [SetRowHeight](./Methods/SetRowHeight.md) | boolean | 设置行高值。 |
| [SetSort](./Methods/SetSort.md) | 无 | 根据请求中指定的参数对给定范围内的单元格进行排序。 |
| [SetStrikeout](./Methods/SetStrikeout.md) | boolean | 指定单元格/单元格范围的内容显示时在内容中心有一条水平删除线。 |
| [SetUnderline](./Methods/SetUnderline.md) | boolean | 指定当前单元格/单元格范围的内容显示时字符正下方有一条下划线。 |
| [SetValue](./Methods/SetValue.md) | boolean | 设置当前单元格或单元格范围的值。 |
| [SetWrap](./Methods/SetWrap.md) | boolean | 指定单元格中的文字是否必须换行以适应单元格大小。 |
| [UnMerge](./Methods/UnMerge.md) | boolean | 将选定的合并单元格范围拆分为单个单元格。 |
