...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| arg1 | 必需 | [ApiRange](../../ApiRange/ApiRange.md) \| [ApiName](../../ApiName/ApiName.md) \| number |  | 指定用于分类汇总的函数的数值：**1 (101)** - AVERAGE，**2 (102)** - COUNT，**3 (103)** - COUNTA，**4 (104)** - MAX，**5 (105)** - MIN，**6 (106)** - PRODUCT，**7 (107)** - STDEV，**8 (108)** - STDEVP，**9 (109)** - SUM，**10 (110)** - VAR，**11 (111)** - VARP。1-11 包含手动隐藏的行，而 101-111 排除它们；筛选掉的单元格始终被排除。 |
