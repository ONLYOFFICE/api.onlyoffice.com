...
| [GetClassType](./Methods/GetClassType.md) | "form" | 返回 ApiFormBase 类的类型。 |
...
| [GetValue](./Methods/GetValue.md) | string \| boolean | 返回表单字段的当前值。 |
...
| [SetValue](./Methods/SetValue.md) | boolean | 设置表单字段的值。 |
