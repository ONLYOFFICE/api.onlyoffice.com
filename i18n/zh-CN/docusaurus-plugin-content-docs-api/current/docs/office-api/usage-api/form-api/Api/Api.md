...
| [CreateCheckBoxForm](./Methods/CreateCheckBoxForm.md) | [ApiCheckBoxForm](../ApiCheckBoxForm/ApiCheckBoxForm.md) | 使用指定的复选框/单选按钮属性创建复选框/单选按钮。 |
| [CreateComboBoxForm](./Methods/CreateComboBoxForm.md) | [ApiComboBoxForm](../ApiComboBoxForm/ApiComboBoxForm.md) | 使用指定的组合框/下拉列表属性创建组合框/下拉列表。 |
...
| [CreateSignatureForm](./Methods/CreateSignatureForm.md) | [ApiSignatureForm](../ApiSignatureForm/ApiSignatureForm.md) | 使用指定的表单属性创建签名表单。 |
