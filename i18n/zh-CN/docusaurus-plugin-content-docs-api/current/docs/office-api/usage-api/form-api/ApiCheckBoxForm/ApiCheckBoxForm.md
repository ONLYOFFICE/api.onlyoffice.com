...
| [GetGroupValue](./Methods/GetGroupValue.md) | string | 返回组中当前选中的单选按钮的选项名称。 |
...
| [GetValue](./Methods/GetValue.md) | boolean | 将复选框表单的当前状态作为布尔值返回。 |
...
| [SetGroupValue](./Methods/SetGroupValue.md) | boolean | 选择组中具有指定选项名称的单选按钮。 |
...
| [SetValue](./Methods/SetValue.md) | boolean | 设置复选框表单的状态。 |
