...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| sType | 必需 | [BorderType](../../Enumeration/BorderType.md) |  | 单元格底部边框样式。 |
| nSize | 必需 | [pt_8](../../Enumeration/pt_8.md) |  | 当前单元格底部边框的宽度，以点的八分之一为单位。 |
| nSpace | 必需 | [pt](../../Enumeration/pt.md) |  | 表格单元格底部用于放置此边框的间距偏移量，以磅为单位。 |
