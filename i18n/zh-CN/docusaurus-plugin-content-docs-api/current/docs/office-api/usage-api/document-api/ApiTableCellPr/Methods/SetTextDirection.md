...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| sType | 必需 | [TextFlowDirection](../../Enumeration/TextFlowDirection.md) |  | 表格单元格中可用的文字方向类型：&lt;code&gt;"lrtb"&lt;/code&gt; - 从左到右、从上到下的文字方向，&lt;code&gt;"tbrl"&lt;/code&gt; - 从上到下、从右到左的文字方向，&lt;code&gt;"btlr"&lt;/code&gt; - 从下到上、从左到右的文字方向。 |
