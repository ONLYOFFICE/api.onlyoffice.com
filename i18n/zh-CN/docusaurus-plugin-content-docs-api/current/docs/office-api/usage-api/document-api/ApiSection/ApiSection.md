...
| [RemoveFooter](./Methods/RemoveFooter.md) | boolean | 从当前节中移除指定类型的页脚。移除后，页脚将从 |
| [RemoveHeader](./Methods/RemoveHeader.md) | boolean | 从当前节中移除指定类型的页眉。移除后，页眉将从 |
...
| [SetMargins](./Methods/SetMargins.md) | boolean | 指定此节中所有页面的页边距。[ApiSection#SetPageMargins](../ApiSection/Methods/SetPageMargins.md) 的别名。 |
| [SetNotEqualColumns](./Methods/SetNotEqualColumns.md) | boolean | 指定当前节中的所有栏具有不同的宽度。栏数等于 |
...
| [SetType](./Methods/SetType.md) | boolean | 指定当前节的类型。节类型定义当前 |
