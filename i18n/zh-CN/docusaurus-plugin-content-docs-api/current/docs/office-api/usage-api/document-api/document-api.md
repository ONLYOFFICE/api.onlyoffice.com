...
如您所见，您只需使用 [CDocBuilder](../../../document-builder/builder-framework/CDocBuilder/CDocBuilder.md) 类的 *builder.OpenFile* 方法，并将必要文本文档的路径或 URL 作为参数传递即可打开它。在上面的示例中，我们打开 **mydocument.docx** 文档，获取其第一个段落并将其中的文本更改为居中的"Center"文本。同样，任何其他文本文档元素都可以更改。
