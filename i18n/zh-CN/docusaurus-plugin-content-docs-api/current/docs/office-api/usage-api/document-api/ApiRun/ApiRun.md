...
| [AddComment](./Methods/AddComment.md) | [ApiComment](../ApiComment/ApiComment.md) | 向当前文本块添加批注。💡 请注意，此文本块必须在文档中。 |
...
| [GetRange](./Methods/GetRange.md) | [ApiRange](../ApiRange/ApiRange.md) | 返回表示指定文本块中所包含文档部分的 Range 对象。 |
...
| [MoveCursorToPos](./Methods/MoveCursorToPos.md) | boolean | 将光标移动到当前文本块的指定位置。如果当前文本块未分配给任何文档部分，则返回 **false**。否则，此方法返回 **true**。如果文档中有任何选区，将被移除。 |
