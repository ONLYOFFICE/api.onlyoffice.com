...
| [DeleteAttribute](./Methods/DeleteAttribute.md) | boolean | 从自定义 XML 节点删除属性。 |
| [GetAttribute](./Methods/GetAttribute.md) | string \| null | 从自定义 XML 节点检索属性值。 |
...
| [GetText](./Methods/GetText.md) | string | 返回当前节点及其子节点的内部文本。 |
| [GetXPath](./Methods/GetXPath.md) | string | 返回当前 XML 节点的绝对 XPath。 |
| [GetXml](./Methods/GetXml.md) | string | 返回当前节点的 XML 字符串。 |
| [SetAttribute](./Methods/SetAttribute.md) | boolean | 为自定义 XML 节点设置属性。 |
...
| [UpdateAttribute](./Methods/UpdateAttribute.md) | boolean | 更新自定义 XML 节点中现有属性的值。 |
