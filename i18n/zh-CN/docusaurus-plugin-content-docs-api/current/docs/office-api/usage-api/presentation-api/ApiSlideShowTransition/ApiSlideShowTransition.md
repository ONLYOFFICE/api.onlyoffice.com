...
| [GetSpeed](./Methods/GetSpeed.md) | [TransitionSpeed](../Enumeration/TransitionSpeed.md) | 返回切换速度（类似于 PowerPoint VBA Speed 属性）。 |
...
| [SetSpeed](./Methods/SetSpeed.md) | boolean | 设置切换速度（类似于 PowerPoint VBA Speed 属性）。 |
