...
- **脚本测试**：使用提供的 ONLYOFFICE API（[Office JavaScript API](/docs/office-api/get-started/overview)、[自动 API](/docs/docs-api/usage-api/automation-api/) 或 [宏](./get-started.md)）编写和运行 JavaScript 代码。
