...
插件图标图像文件在 [config.json](../structure/configuration/configuration.md#variationsicons) 文件中通过 URL 指定。该 URL 允许你按照以下格式设置主题（名称、类型）、状态（normal、hover、active）和缩放规则：
...
| 参数   | 类型      | 例子           | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|------------|--------|-------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| theme-name | string | `"classic"` | 主题名称（系统、深色主题等）                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| theme-type | string | `"light"`   | 插件图标的主题类型。可以为浅色或深色。                                                                                                                                                                                                                                                                                                                                                                                                               |
| state      | string | `"normal"`  | 图标状态。可用的值包括：默认状态、悬停状态、激活状态。当该参数为默认状态时，最终生成的 URL 中会被替换为空字符串。悬停状态和激活状态值将分别替换为 *_hover* 和 *_active*。                                                                                                                                                                                                                       |
