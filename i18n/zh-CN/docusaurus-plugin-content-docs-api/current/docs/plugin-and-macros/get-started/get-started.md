...
- 如何使用 [AI 工具](../ai/ai-plugin.md)，添加[自定义提供商](../ai/custom-providers.md)，配置 [AI 助手](../ai/ai-agent.md)，创建[自定义工具](../ai/custom-ai-tools.md)，以及使用[文本注释](../ai/text-annotations-guide.md)
...
- 哪里可以找到指南以及[插件](../samples/plugin-samples/plugin-samples.md)/[宏](../samples/macro-samples/macro-samples.md)/[自定义 AI 工具](../samples/custom-ai-tools/custom-ai-tools.md)代码案例以进行入门学习
