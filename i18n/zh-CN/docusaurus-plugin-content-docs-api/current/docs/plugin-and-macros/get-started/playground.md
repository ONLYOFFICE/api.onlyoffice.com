...
- **脚本测试**：使用提供的 ONLYOFFICE API（[Office JavaScript API](../../office-api/get-started/overview.md)、[自动 API](../../docs-api/usage-api/automation-api/automation-api.md) 或 [插件 API](../../plugin-and-macros/get-started/get-started.md)编写和运行 JavaScript 代码。
