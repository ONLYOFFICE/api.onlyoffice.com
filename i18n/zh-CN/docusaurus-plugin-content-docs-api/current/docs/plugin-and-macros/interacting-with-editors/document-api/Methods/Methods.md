...
| [AddAddinField](./AddAddinField.md) | [AddinFieldData](../Enumeration/AddinFieldData.md) | 使用请求中指定的数据创建新的加载项字段。 |
...
| [AnnotateParagraph](./AnnotateParagraph.md) | 无 | 向指定的段落添加注解。 |
...
| [GetAllOleObjects](./GetAllOleObjects.md) | [OLEObjectData](../Enumeration/OLEObjectData.md)[] | 返回可由指定插件打开的对象的所有 OLE 对象数据。 |
...
| [MoveCursorOutsideField](./MoveCursorOutsideField.md) | 无 | 将光标移动到字段外部，定位在字段之前或之后。 |
| [MoveCursorToContentControl](./MoveCursorToContentControl.md) | 无 | 将光标移动到指定的内容控件。 |
| [MoveCursorToEnd](./MoveCursorToEnd.md) | 无 | 将光标移动到当前编辑区域（文档正文、页眉/页脚、脚注或自选图形）的末尾。 |
| [MoveCursorToField](./MoveCursorToField.md) | 无 | 将光标移动到字段的开头或末尾。 |
| [MoveCursorToStart](./MoveCursorToStart.md) | 无 | 将光标移动到当前编辑区域（文档正文、页眉/页脚、脚注或自选图形）的开头。 |
...
| [RemoveAnnotationRange](./RemoveAnnotationRange.md) | 无 | 从文档中移除特定的注解范围。 |
...
| [SelectAnnotationRange](./SelectAnnotationRange.md) | 无 | 使用给定的注解在文档中选择文本。 |
...
| [SetParagraphHtml](./SetParagraphHtml.md) | 无 | 用从给定 HTML 字符串解析的内容替换指定段落的所有内容。 |
