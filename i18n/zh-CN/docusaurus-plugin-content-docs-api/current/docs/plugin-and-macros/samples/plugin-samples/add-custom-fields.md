...
从 [GitHub](https://github.com/ONLYOFFICE/sdkjs-plugins/tree/master/example_customfields_add) 下载此插件，并根据以下方式的说明进行安装：[**桌面端**](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md)、[**本地部署**](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/docs-on-premises-installation.md) 或 [**云端**](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md)。
