...
你也可以从 [ONLYOFFICE 插件目录](https://www.onlyoffice.com/app-directory/zh/wordscounter)下载此插件，并按照以下说明完成安装：[桌面端](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md)、[云端](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md)。
