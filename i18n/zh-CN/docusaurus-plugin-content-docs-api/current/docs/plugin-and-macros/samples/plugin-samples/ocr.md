...
可根据以下说明将其移除：[桌面端](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md)、[本地部署](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/docs-on-premises-installation.md)、[云端](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md)。
