...
从 [GitHub](https://github.com/ONLYOFFICE/sdkjs-plugins/tree/master/example_search_replace) 下载该插件，并按照以下说明进行安装：[桌面端](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md)、[本地部署](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/docs-on-premises-installation.md)或[云端](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md)。
