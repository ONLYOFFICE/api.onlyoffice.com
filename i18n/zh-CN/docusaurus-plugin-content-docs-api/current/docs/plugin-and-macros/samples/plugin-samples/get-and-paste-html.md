...
你也可以从 [ONLYOFFICE 应用目录](https://www.onlyoffice.com/app-directory/en/html)下载该插件，并按照[桌面端](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md)或[云端](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md)的安装说明进行安装。
