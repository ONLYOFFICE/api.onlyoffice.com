...
你也可以从 [ONLYOFFICE 应用目录](https://www.onlyoffice.com/app-directory/en/html)下载该插件，并按照[桌面端](../../tutorials/installing/onlyoffice-desktop-editors.md)或[云端](../../tutorials/installing/onlyoffice-cloud.md)的安装说明进行安装。
