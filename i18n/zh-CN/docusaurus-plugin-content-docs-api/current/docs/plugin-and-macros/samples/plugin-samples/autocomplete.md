...
从 [ONLYOFFICE 应用目录](https://www.onlyoffice.com/app-directory/en/autocomplete)下载此插件，并按照[桌面版](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md)，[本地部署版](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/docs-on-premises-installation.md)或者[云端版](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md)的安装说明进行安装。
