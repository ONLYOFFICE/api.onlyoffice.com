...
如需移除该插件，请参阅以下指南：[桌面版](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/desktop-editors-installation.md)、[本地部署版](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/docs-on-premises-installation.md)或[云端版](/docs/plugin-and-macros/plugins/development-workflow/installing-and-testing/cloud-saas-installation.md)。
