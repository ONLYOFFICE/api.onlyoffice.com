...
使用方法：[获取演示文稿](/docs/office-api/usage-api/presentation-api/Api/Methods/GetPresentation.md)，[获取幻灯片数量](/docs/office-api/usage-api/presentation-api/ApiPresentation/Methods/GetSlidesCount.md)，[按索引获取幻灯片](/docs/office-api/usage-api/presentation-api/ApiPresentation/Methods/GetSlideByIndex.md)，[获取所有形状](/docs/office-api/usage-api/presentation-api/ApiSlide/Methods/GetAllShapes.md)，[设置位置](/docs/office-api/usage-api/presentation-api/ApiDrawing/Methods/SetPosition.md)，[创建 OLE 对象](/docs/office-api/usage-api/presentation-api/Api/Methods/CreateOleObject.md)，[设置尺寸](/docs/office-api/usage-api/presentation-api/ApiDrawing/Methods/SetSize.md)，[添加对象](/docs/office-api/usage-api/presentation-api/ApiSlide/Methods/AddObject.md)，[获取文档内容](/docs/office-api/usage-api/presentation-api/ApiShape/Methods/GetDocContent.md)，[设置颜色](/docs/office-api/usage-api/presentation-api/ApiRun/Methods/SetColor.md)，[设置字体](/docs/office-api/usage-api/presentation-api/ApiRun/Methods/SetFontFamily.md)
