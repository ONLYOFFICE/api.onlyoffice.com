...
:::note
所有 [Office JavaScript API](../../../../office-api/get-started/overview.md) 功能已包含在所有版本的 ONLYOFFICE 文档编辑器中（包括开源版），插件正是通过这些功能与编辑器交互的。如需在没有文档编辑器的情况下创建文档，请安装独立的 **ONLYOFFICE 文档建构器**版本。
:::

唯一的确定按钮（window.Asc.plugin.button = function (id) \{...\}）用于创建文本并结束插件操作。

更多现有的开源插件示例可在[此处](../../../samples/plugins/hello-world.md)查看。
