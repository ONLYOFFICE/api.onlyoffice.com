...
| [GoToNextSlideInSlideShow](./GoToNextSlideInSlideShow.md) | 无 | 在幻灯片放映中显示当前幻灯片之后的幻灯片。 |
| [GoToPreviousSlideInSlideShow](./GoToPreviousSlideInSlideShow.md) | 无 | 在幻灯片放映中显示当前幻灯片之后的幻灯片。 |
| [GoToSlide](./GoToSlide.md) | 无 | 通过索引在编辑器中设置活动幻灯片。 |
| [GoToSlideInSlideShow](./GoToSlideInSlideShow.md) | 无 | 显示具有特定索引的幻灯片。 |
...
| [PauseSlideShow](./PauseSlideShow.md) | 无 | 暂停当前幻灯片放映。 |
...
| [RemoveOleObject](./RemoveOleObject.md) | 无 | 通过内部 ID 从演示文稿中删除 OLE 对象。 |
...
| [ResumeSlideShow](./ResumeSlideShow.md) | 无 | 恢复当前幻灯片放映。 |
...
| [StartSlideShow](./StartSlideShow.md) | 无 | 开始演示文稿幻灯片放映。 |
