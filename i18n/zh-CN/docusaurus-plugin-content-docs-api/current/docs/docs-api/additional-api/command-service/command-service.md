...
:::note
在版本4.2之前的 **ONLYOFFICE 文档服务器**中，使用了带有查询字符串中参数的GET请求。
:::
...
| 名称  | 类型   | 是否必填                  | 描述                                                                                                                                                                    |
| ----- | ------ | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| token | string | 配置所需 | 定义以[令牌](../../additional-api/signature/request/token-in-body.md#get-document-status)形式添加到 **ONLYOFFICE 文档**配置的加密签名。 |
