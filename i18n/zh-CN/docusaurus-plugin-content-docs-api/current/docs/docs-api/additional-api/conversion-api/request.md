...
| watermark | object | optional | 定义一个 JSON 对象，其中包含水印的[属性](../../../plugins/interacting-with-editors/document-api/Enumeration/watermark_on_draw.md)，在转换过程中将其插入到 pdf 和图像文件中。 |
