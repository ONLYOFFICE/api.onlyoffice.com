...
- 如果无法在 WOPI 中[锁定](../using-wopi/key-concepts.md#lock)文档，则文档将以查看模式打开并显示错误消息。
- 在 *CheckFileInfo* WOPI 操作中新增 [UserCanOnlyComment](../using-wopi/wopi-rest-api/checkfileinfo.md#UserCanOnlyComment) 属性。
...
- 新增将 [pptx](../additional-api/conversion-api/conversion-tables.md#presentation-file-formats) 格式转换为 *txt* 的功能。
