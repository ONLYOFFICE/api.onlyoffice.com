...
- **脚本测试**：使用 ONLYOFFICE 提供的 API（[Office JavaScript API](/docs/office-api/get-started/overview)、[Automation API](../usage-api/automation-api/automation-api.md) 或 [Plugins API](/docs/plugins/get-started/)) 编写并运行 JavaScript 代码。
