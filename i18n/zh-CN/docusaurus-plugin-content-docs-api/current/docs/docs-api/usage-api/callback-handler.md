...
| 参数          | 类型            | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|--------------------|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| actions            | array of object | 定义当用户对文档执行操作时接收到的对象。`type` 字段值可以具有以下值：<br />**0** - 用户断开与文档共同编辑的连接，<br />**1** - 新用户连接到文档共同编辑，<br />**2** - 用户单击[强制保存按钮](./config/editor/customization/customization-standard-branding.md#forcesave)。<br />`userid` 字段值是用户标识符。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
