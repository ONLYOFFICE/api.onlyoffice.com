...
| 参数          | 类型            | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|--------------------|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| actions            | array of objects | 定义当用户对文档执行操作时接收到的对象。`type` 字段值可以具有以下值：<br />**0** - 用户断开与文档共同编辑的连接，<br />**1** - 新用户连接到文档共同编辑，<br />**2** - 用户单击[强制保存按钮](./config/editor/customization/customization-standard-branding.md#forcesave)。<br />`userid` 字段值是用户标识符。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| changeshistory     | array of objects | 定义具有文档更改历史的对象数组。仅当 `status` 值等于 **2** 或 **3** 时，对象才存在。 必须作为对象的属性 `changes` 以参数形式发送给 [refreshHistory](./methods.md#refreshhistory) 方法。自 4.2 版起已删除，请改用 [history](#history)。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
