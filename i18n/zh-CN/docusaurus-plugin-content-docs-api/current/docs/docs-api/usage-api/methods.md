...
| 参数                         | 类型    | 是否必填 | 描述                                                                                                                                       |
| ----------------------------- | ------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| options.currentVersion        | `number` | 必填 | 定义当前文档版本号。                                                                                                      |
| options.error                 | `string` | 非必填的 | 定义错误消息文本。                                                                                                                   |
| options.history               | `object[]` | 必填 | 使用文档版本定义数组。                                                                                                    |
...
| options.history.serverVersion | `number` | 非必填的 | 定义当前服务器版本号。 如果发送 `changes` 参数，则还需要发送 `serverVersion` 参数。 |
...
| options.history.version       | `number` | 必填 | 定义文档版本号。                                                                                                              |
...
| options.version           | `number` | 必填 | 定义文档版本号。                                                                                                                                                                                                                                                                                        |
...
| options.users       | `object[]` | 非必填的 | 定义用户列表。                                                                                                                                                                                   |
