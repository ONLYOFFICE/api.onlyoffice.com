...
| *icons*    | string                   | 项目图标（请参阅插件 [config](/docs/plugins/fundamentals/configuration/config-json#variationsicons)文档）。 |
...
调用该函数将项目添加到工具栏菜单。使用工具栏菜单的过程与 [plugins](/docs/plugins/customization/toolbar) 相同，除了使用 *onClick* 方法代替通过 ID 订阅。
...
| *hint*           | string                                      | 项目提示。                                                                                                                           |
| *icons*          | string \| object                            | 项目图标（请参阅插件 [config](/docs/plugins/fundamentals/configuration/config-json#variationsicons) 文档）。 |
...
| 名称     | 类型     | 描述                                                                                                                                                                                                                                                                                                                                                                      |
| -------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| command  | function | 定义用JavaScript编写的命令，其目的是形成可插入结果文档文件（格式化段落、表格、文本部分和单独单词等）的结构化数据。然后将数据发送给编辑器。该命令必须与 [Office JavaScript API](/docs/office-api/get-started/overview) 语法兼容。|
...
此方法在与其他JavaScript数据隔离的上下文中执行。如果需要将某些参数或其他数据传递给此方法，请使用 [Asc.scope](/docs/plugins/interacting-with-editors/overview/how-to-call-commands#ascscope-object) 对象。
