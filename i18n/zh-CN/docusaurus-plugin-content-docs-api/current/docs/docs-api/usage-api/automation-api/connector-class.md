...
调用该函数将项目添加到上下文菜单。上下文菜单的操作过程与 [plugins](../../../plugin-and-macros/plugins/customization/context-menu.md) 相同，但 *onClick* 方法除外，该方法用于代替通过 ID 订阅。
...
| *icons*    | string                   | 项目图标（请参阅插件 [config](../../../plugin-and-macros/plugins/fundamentals/configuration/config-json.md#variationsicons)文档）。 |
...
调用该函数将项目添加到工具栏菜单。使用工具栏菜单的过程与 [plugins](../../../plugin-and-macros/plugins/customization/toolbar.md) 相同，除了使用 *onClick* 方法代替通过 ID 订阅。
...
| *hint*           | string                                      | 项目提示。                                                                                                                           |
| *icons*          | string \| object                            | 项目图标（请参阅插件 [config](../../../plugin-and-macros/plugins/fundamentals/configuration/config-json.md#variationsicons) 文档）。 |
...
- [文本文档事件](../../../plugin-and-macros/plugins/interacting-with-editors/text-document-api/Events/Events.md)
- [电子表格事件](../../../plugin-and-macros/plugins/interacting-with-editors/spreadsheet-api/Events/Events.md)
- [演示文稿事件](../../../plugin-and-macros/plugins/interacting-with-editors/presentation-api/Events/Events.md)
- [PDF 事件](../../../plugin-and-macros/plugins/interacting-with-editors/pdf-api/Events/Events.md)
- [表单事件](../../../plugin-and-macros/plugins/interacting-with-editors/form-api/Events/Events.md)
...
此方法在与其他JavaScript数据隔离的上下文中执行。如果需要将某些参数或其他数据传递给此方法，请使用 [Asc.scope](../../../plugin-and-macros/plugins/interacting-with-editors/overview/how-to-call-commands.md#ascscope-object) 对象。
...
- [文本文档方法](../../../plugin-and-macros/plugins/interacting-with-editors/text-document-api/Methods/Methods.md)
- [电子表格方法](../../../plugin-and-macros/plugins/interacting-with-editors/spreadsheet-api/Methods/Methods.md)
- [演示文稿方法](../../../plugin-and-macros/plugins/interacting-with-editors/presentation-api/Methods/Methods.md)
- [PDF 方法](../../../plugin-and-macros/plugins/interacting-with-editors/pdf-api/Methods/Methods.md)
- [表单方法](../../../plugin-and-macros/plugins/interacting-with-editors/form-api/Methods/Methods.md)
