...
| *icons*    | string                   | 项目图标（请参阅插件 [config](../../../plugins/fundamentals/configuration/config-json.md#variationsicons) 文档）。 |
...
| *hint*           | string                                      | 项目提示。                                                                                                                           |
| *icons*          | string \| object                            | 项目图标（请参阅插件 [config](../../../plugins/fundamentals/configuration/config-json.md#variationsicons) 文档）。 |
