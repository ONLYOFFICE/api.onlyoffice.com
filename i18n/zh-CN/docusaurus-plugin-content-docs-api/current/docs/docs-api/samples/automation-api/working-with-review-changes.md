...
2. 当用户单击自定义界面中的 **接受/拒绝** 按钮时，将执行 [AcceptReviewChanges](/docs/plugin-and-macros/plugins/interacting-with-editors/text-document-api/Methods/AcceptReviewChanges.md) / [RejectReviewChanges](/docs/plugin-and-macros/plugins/interacting-with-editors/text-document-api/Methods/RejectReviewChanges.md) 方法来接受/拒绝编辑器中的选定更改：
...
3. 当用户单击自定义界面中的 **上一个/下一个** 按钮时，将执行 [MoveToNextReviewChange](/docs/plugin-and-macros/plugins/interacting-with-editors/text-document-api/Methods/MoveToNextReviewChange.md) 方法，在评审更改之间导航：
