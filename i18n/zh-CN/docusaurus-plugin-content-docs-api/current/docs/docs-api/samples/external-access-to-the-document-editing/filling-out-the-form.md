...
3. 当用户编辑表单值时，会触发 [onChangeContentControl](/docs/plugin-and-macros/plugins/interacting-with-editors/text-document-api/Events/onChangeContentControl.md) 事件，然后执行 GetFormValue 方法以获取更新的表单值并将其显示在自定义界面中：
