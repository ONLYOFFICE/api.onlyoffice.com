...
要在您的本地计算机上运行示例，您将需要[Python 3.11.4](https://www.python.org/)和[pip 23.1.2](https://pip.pypa.io/en/stable/)。另外，您可能需要考虑安装[GNU Make 4.4.1](https://www.gnu.org/software/make/)，不过这是可选的。这些是工具所需的最低版本。
