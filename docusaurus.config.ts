...
const config: Config = {
  ...
  plugins: [
    ...
    ...(locale === 'en' ? [[
      ...
      {
        docsDir: [
          {path: 'site/docs/docs-api', routeBasePath: '/', label: 'ONLYOFFICE Docs: Docs API'},
          {path: 'site/docs/plugins', routeBasePath: '/', label: 'ONLYOFFICE Docs: Plugins'},
          {path: 'site/docs/macros', routeBasePath: '/', label: 'ONLYOFFICE Docs: Macros'},
          {path: 'site/docs/ai', routeBasePath: '/', label: 'ONLYOFFICE Docs: AI'},
          {path: 'site/docs/document-builder', routeBasePath: '/', label: 'ONLYOFFICE Docs: Document Builder'},
          {path: 'site/docs/desktop-editors', routeBasePath: '/', label: 'ONLYOFFICE Docs: Desktop Editors'},
          {path: 'site/docspace/api-backend', routeBasePath: '/', label: 'ONLYOFFICE DocSpace: API Reference'},
          {path: 'site/docspace/javascript-sdk', routeBasePath: '/', label: 'ONLYOFFICE DocSpace: Embed SDK'},
          {path: 'site/docspace/plugins-sdk', routeBasePath: '/', label: 'ONLYOFFICE DocSpace: Plugins SDK'},
          {path: 'site/docspace/mcp-server', routeBasePath: '/', label: 'ONLYOFFICE DocSpace: MCP Server'},
          {path: 'site/docs/office-api', routeBasePath: '/', label: 'ONLYOFFICE Docs: Office API'},
        ],
