...
export function isPropertyReflection(r: unknown): r is R<J.DeclarationReflection, K.Property> {
  return isDeclarationReflection(r) && isPropertyKind(r.kind)
}

export function isMethodReflection(r: unknown): r is R<J.DeclarationReflection, K.Method> {
