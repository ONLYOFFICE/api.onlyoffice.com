...
- **Plugins and Macros**:
  - Added [AI custom tools text annotations](/docs/ai/guides/custom-ai-tools) feature documentation.
  ...
  - Added [bookmark last view macro example](/docs/macros/samples/document-editor/bookmark-last-view).
...
- Fixed [Currency Conversion](/docs/macros/samples/spreadsheet-editor/currency-conversion) macro to use proper `RecalculateAllFormulas` API instead of internal method with timeout.
- Fixed [Hide or Unhide Rows and Columns](/docs/macros/samples/spreadsheet-editor/hide-or-unhide-rows-and-columns) macro example.
