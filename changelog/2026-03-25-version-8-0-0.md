...
- **Plugins and Macros**:
  ...
  - Added [bookmark last view macro example](/docs/plugin-and-macros/samples/macros/text-document-editor/bookmark-last-view).
...
- Fixed [Currency Conversion](/docs/plugin-and-macros/samples/macros/spreadsheet-editor/currency-conversion) macro to use proper `RecalculateAllFormulas` API instead of internal method with timeout.
- Fixed [Hide or Unhide Rows and Columns](/docs/plugin-and-macros/samples/macros/spreadsheet-editor/hide-or-unhide-rows-and-columns) macro example.
