...
- **Plugins and Macros**:
  - Added [AI custom tools text annotations](/docs/plugin-and-macros/ai/custom-ai-tools) feature documentation.
  ...
  - Added [bookmark last view macro example](/docs/plugin-and-macros/samples/macro-samples/text-document-editor/bookmark-last-view).
  - Added [OData plugin](/docs/plugin-and-macros/samples/plugin-samples) to plugin examples.
...
- Fixed [Currency Conversion](/docs/plugin-and-macros/samples/macro-samples/spreadsheet-editor/currency-conversion) macro to use proper `RecalculateAllFormulas` API instead of internal method with timeout.
- Fixed [Hide or Unhide Rows and Columns](/docs/plugin-and-macros/samples/macro-samples/spreadsheet-editor/hide-or-unhide-rows-and-columns) macro example.
