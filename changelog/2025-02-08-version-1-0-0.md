...
- **Common**:
  ...
  - Added [Office JS API](/docs/office-api/get-started/overview) and [Plugins API](/docs/plugins/interacting-with-editors/overview) from https://github.com/ONLYOFFICE/office-js-api.
