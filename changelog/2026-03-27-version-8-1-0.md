...
- **Plugins and Macros**:
  - Reworked the [Get Started](/docs/plugin-and-macros/get-started/) section with improved quick-start tutorials.
  ...
  - Added [Insert Formulas Row](/docs/plugin-and-macros/samples/macro-samples/spreadsheet-editor/insert-formulas-row) macro sample for spreadsheet editor.
  - Added [Create AI assistant](/docs/plugin-and-macros/ai/ai-agent#create-ai-assistant) documentation with example.
...
- **Docs API**:
  ...
  - Added [Working with content controls](/docs/docs-api/samples/external-access-to-the-document-editing/working-with-content-controls) sample for Automation API.
  - Added links to all editor methods (text document, spreadsheet, presentation, PDF, form) in the connector [executeMethod](/docs/docs-api/usage-api/automation-api/connector-class#executemethod) section.

- **Office API**:
  - Added [Creating spreadsheet with alternating row colors](/docs/office-api/samples/spreadsheet-editor/creating-spreadsheet-with-alternating-row-colors) sample for Spreadsheet API.
