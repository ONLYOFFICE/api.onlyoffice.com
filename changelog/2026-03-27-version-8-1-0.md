...
- **Plugins and Macros**:
  - Reworked the [Get Started](/docs/plugins/get-started/overview) section with improved quick-start tutorials.
  - Added [Hello World Plugin](/docs/plugins/get-started/quick-start/) guide.
