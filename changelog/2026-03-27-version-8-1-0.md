...
- **Plugins and Macros**:
  ...
  - Added [Hello World Macro](/docs/macros/get-started/quick-start) guide.
  - Added [Comment Text AI Tool](/docs/ai/get-started/quick-start) tutorial.
  - Added [Insert Formulas Row](/docs/macros/samples/spreadsheet-editor/insert-formulas-row) macro sample for spreadsheet editor.
  - Added [Create AI assistant](/docs/ai/guides/ai-agent#create-ai-assistant) documentation with example.
