...
- **Docs API**:
  ...
  - Restructured [Automation API](/docs/docs-api/usage-api/automation-api/automation-api) documentation into a dedicated section with separate pages for [Connector class](/docs/docs-api/usage-api/automation-api/connector-class) and [Connector window](/docs/docs-api/usage-api/automation-api/connector-window) methods.
