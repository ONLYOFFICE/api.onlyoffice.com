...
- **Docs API**:
  - Added [`Recording macros`](/docs/macros/macros/recording-macros/) page
  - Added [`AI Agent`](/docs/ai/ai/ai-agent/) and [`AI Plugin`](/docs/ai/ai/ai-plugin/) pages for Chinese
