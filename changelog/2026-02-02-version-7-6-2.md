...
- **Docs API**:
  - Added [`Recording macros`](/docs/macros/guides/recording-macros/) page
  - Added [`AI Agent`](/docs/ai/guides/ai-agent/) and [`AI Plugin`](/docs/ai/guides/ai-plugin/) pages for Chinese
