...
- [How to disable feature tips in editors?](customizing.md#how-to-disable-feature-tips-in-the-editors)
...
- [How to hide the active user's icon and the current username in the editor header?](customizing.md#how-to-hide-the-active-user's-icon-and-the-current-username-in-the-editor-header)
