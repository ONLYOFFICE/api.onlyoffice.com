...
- Changed customization [uitheme](/site/docs/docs-api/usage-api/config/editor/customization/customization-standard-branding.md#uitheme) parameter: in version 9.1 mobile editors support limited themes.
