...
[ONLYOFFICE Docs](https://www.onlyoffice.com/download-docs.aspx?from=api#docs-developer) is an open-source office suite that includes editors for documents, spreadsheets, presentations, PDFs, and fillable forms.
...
- How to manage editors via [Automation API](../usage-api/automation-api/automation-api.md)
...
- creating, editing and viewing documents, spreadsheets, presentations, PDFs, and fillable forms;
