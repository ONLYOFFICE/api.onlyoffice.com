---
description: Integrate ONLYOFFICE Docs into Liferay for document editing and collaboration.
...
This [app](https://github.com/ONLYOFFICE/onlyoffice-liferay) enables users to edit office documents from [Liferay](https://www.liferay.com/) using ONLYOFFICE Docs.
...
1. The user navigates to the **Documents and Media** section within Liferay and selects the **Edit in ONLYOFFICE** action.

2. Liferay prepares a JSON object for ONLYOFFICE Docs with the following properties:
...
6. Liferay locks the document, but still allows other users with write access to collaborate in real time with ONLYOFFICE Docs by keeping the **Edit in ONLYOFFICE** action available.
