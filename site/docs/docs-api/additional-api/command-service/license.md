...
| quota.users              | object[] | required | Defines the user quota for the user license.                                                                                                                                                                                                                         |
| quota.users.userid       | string           | required | Defines the id of the user who opened the editor.                                                                                                                                                                                                                    |
| quota.users.expire       | string           | required | Defines the date of license expiration for this user.                                                                                                                                                                                                                |
| quota.users_view         | object[] | required | Defines the user quota for the live viewer.                                                                                                                                                                                                                          |
| quota.users_view.userid  | string           | required | Defines the id of the user who opened the document for viewing.                                                                                                                                                                                                      |
| quota.users_view.expire  | string           | required | Defines the date of viewing expiration for this user.                                                                                                                                                                                                                |
