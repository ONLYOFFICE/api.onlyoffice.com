...
| quota.users              | object[] | required | Defines the user quota for the user license where:<br /><br />**userid** - the id of the user who opened the editor,<br /><br />**expire** - date of license expiration for this user.                                                                                    |
| quota.users_view         | object[] | required | Defines the user quota for the live viewer where:<br /><br />**userid** - the id of the user who opened the editor,<br /><br />**expire** - date of viewing expiration for this user.                                                                                     |
