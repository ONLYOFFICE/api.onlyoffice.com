...
| watermark | object | optional | Defines a JSON object containing the [properties](../../../plugins/interacting-with-editors/document-api/Enumeration/watermark_on_draw.md) of a watermark which is inserted into the pdf and image files during conversion. |
