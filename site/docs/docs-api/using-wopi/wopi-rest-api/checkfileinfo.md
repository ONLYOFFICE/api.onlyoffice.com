...
| Name                        | Type    | Example                     | Description                                                                                                                                                                                                                                                                                         |
|-----------------------------|---------|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ClosePostMessage            | boolean | true                        | Whether the host expects to receive the [UI\_Close](../postmessage.md#UI_Close) PostMessage when the **Close** UI in the online office is activated.                                                                                                                                           |
| EditModePostMessage         | boolean | true                        | Whether the host expects to receive the [UI\_Edit](../postmessage.md#UI_Edit) PostMessage when the *Edit* UI in the online office is activated. If this property is not set to *true*, the online office navigates the inner iframe URL to an edit action URL when the *Edit* UI is activated. |
| EditNotificationPostMessage | boolean | true                        | Whether the host expects to receive the [Edit\_Notification](../postmessage.md#Edit_Notification) PostMessage.                                                                                                                                                                                 |
| FileSharingPostMessage      | boolean | true                        | Whether the host expects to receive the [UI\_Sharing](../postmessage.md#UI_Sharing) PostMessage when the *Share* UI in the online office is activated.                                                                                                                                         |
| FileVersionPostMessage      | boolean | true                        | Whether the host expects to receive the [UI\_FileVersions](../postmessage.md#UI_FileVersions) PostMessage when the *Previous Versions* UI in the online office is activated.                                                                                                                   |
...
| Name             | Type    | Example      | Description                                                                                                                                                                          |
|------------------|---------|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| IsAnonymousUser  | boolean | true         | Whether the user is authenticated with the host or not. Hosts should always set this to *true* for unauthenticated users, so that clients are aware that the user is anonymous. |
...
| Name                    | Type    | Example | Description                                                                                                                                                                                                                                                                                                       |
|-------------------------|---------|---------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ReadOnly                | boolean | true    | Whether a file cannot be changed by the current user.                                                                                                                                                                                                                                                        |
| UserCanNotWriteRelative | boolean | false   | Whether the user has sufficient permission to create new files on the WOPI server. The **true** value means that the [PutRelativeFile](./putrelativefile.md) execution will fail for this user on the current file. By default, this parameter is **false** and the *PutRelativeFile* operation is executed. |
| UserCanRename           | boolean | true    | Whether the user has permissions to rename the current file.                                                                                                                                                                                                                                                 |
| UserCanReview           | boolean | true    | Whether the user has permissions to review the current file.                                                                                                                                                                                                                                                 |
| UserCanWrite            | boolean | true    | Whether the user has permissions to alter the file.                                                                                                                                                                                                                                                          |
...
| Name              | Type    | Example | Description                                                                                                                  |
|-------------------|---------|---------|------------------------------------------------------------------------------------------------------------------------------|
| SupportsLocks     | boolean | true    | Whether the host supports the [Lock](./lock.md), [Unlock](./unlock.md), and [RefreshLock](./refreshlock.md) operations. |
| SupportsRename    | boolean | true    | Whether the WOPI server supports the renaming permission.                                                               |
| SupportsReviewing | boolean | true    | Whether the host supports the review permission.                                                                        |
| SupportsUpdate    | boolean | true    | Whether the host supports the [PutFile](./putfile.md) and [PutRelativeFile](./putrelativefile.md) operations.           |
...
| Name                    | Type    | Example | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------|---------|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| EnableInsertRemoteImage | boolean | true    | Whether to enable the menu entry and toolbar item which call the [UI\_InsertGraphic](../postmessage.md#UI_InsertGraphic) message. This property is used to display a user interface element (for example, a dialog) allowing the user to pick an image from the integration. The integration is supposed to provide a temporary URL that may be downloaded once, and return it back via the [Action\_InsertGraphic](../postmessage.md#Action_InsertGraphic) message with *Values* set to the temporary URL. |
| HidePrintOption         | boolean | false   | Whether the WOPI server hides the print option from the file menu bar in the UI.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Name               | Type    | Example | Description                                                  |
|--------------------|---------|---------|--------------------------------------------------------------|
| UserCanOnlyComment | boolean | true    | Whether the user can only add comments to the document. |
