...
4. When the user clicks the **Prev / Next** buttons in the custom interface, the [MoveToComment](/docs/plugin-and-macros/plugins/interacting-with-editors/text-document-api/Methods/MoveToComment.md) method is executed to navigate between the comments in the document:
