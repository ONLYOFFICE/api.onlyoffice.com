...
2. When the user clicks the arrow buttons in the custom interface, the [MoveToNextReviewChange](/docs/plugin-and-macros/interacting-with-editors/text-document-api/Methods/MoveToNextReviewChange.md) method is executed to move between the next and previous review changes:
