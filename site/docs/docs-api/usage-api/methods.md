...
| options.images.url      | `string` | required | The absolute URL where the source image is stored. Be sure to add a [token](../get-started/how-it-works/security.md) when using local links.                                                                                                              |
| options.token           | `string` | optional | The encrypted signature added to the parameter in the form of a [token](../additional-api/signature/browser.md#insertimage).                                                                                                                             |
| options.url             | `string` | required | The absolute URL where the source image is stored. Be sure to add a [token](../get-started/how-it-works/security.md) when using local links. Otherwise, an error will occur. Deprecated since version 7.0, please use the `options.images.url` parameter instead. |
...
| options.history.changes       | `object` | optional | The `changes` from [the history object](./callback-handler.md#history) returned after saving the document.                                |
...
| options.token             | `string` | optional | The encrypted signature added to the parameter in the form of a [token](../additional-api/signature/browser.md#sethistorydata).                                                                                                                                                                          |
| options.url               | `string` | required | The url address of the current document version. Can be downloaded by the `url` link from [the JSON object](./callback-handler.md#url) returned after saving the document. Be sure to add a [token](../get-started/how-it-works/how-it-works.md) when using local links. Otherwise, an error will occur. |
...
| options.token    | `string` | optional | The encrypted signature added to the parameter in the form of a [token](../additional-api/signature/browser.md#setmailmergerecipients).                                     |
| options.url      | `string` | required | The absolute URL where the source data is stored. Be sure to add a [token](../get-started/how-it-works/security.md) when using local links. Otherwise, an error will occur. |
...
| options.path          | `string` | required | The file name or relative path for the formula editor. It is used to identify a file when the [onRequestReferenceData](./config/events.md#onrequestreferencedata) event is executed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| options.referenceData | `object` | optional | The object that is generated by the integrator to uniquely identify a file in its system. This data must be the same as in the [document.referenceData](./config/document/document.md#referencedata) config parameter. |
| options.token         | `string` | optional | The encrypted signature added to the parameter in the form of a [token](../additional-api/signature/browser.md#setreferencedata).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| options.fileType      | `string` | optional | The extension of the document specified with the `url` parameter.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| options.key           | `string` | optional | The unique document identifier used by the service to take the data from the co-editing session. In case the known key is sent, the document will be taken from the cache. Every time the document is edited and saved, the key must be generated anew. The document url can be used as the `key` but without the special characters and the length is limited to 128 symbol.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| options.path          | `string` | required | The file name or relative path for the formula editor. It is used to identify a file when the [onRequestReferenceSource](./config/events.md#onrequestreferencesource) event is executed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| options.referenceData | `object` | optional | The object that is generated by the integrator to uniquely identify a file in its system. This data must be the same as in the [document.referenceData](./config/document/document.md#referencedata) config parameter. |
| options.token         | `string` | optional | The encrypted signature added to the parameter in the form of a [token](../additional-api/signature/browser.md#setreferencesource).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| options.url           | `string` | required | The URL address to download the current file.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| options.token    | `string` | optional | The encrypted signature added to the parameter in the form of a [token](../additional-api/signature/browser.md#setrequesteddocument).                                           |
| options.url      | `string` | required | The absolute URL where the source document is stored. Be sure to add a [token](../get-started/how-it-works/security.md) when using local links. Otherwise, an error will occur. |
...
| options.fileType | `string` | required | The type of spreadsheet for mail merge in the file: `csv`, `fods`, `ods`, `ots`, `xls`, `xlsm`, `xlsx`, `xlt`, `xltm`, `xltx`.                                      |
| options.token    | `string` | optional | The encrypted signature added to the parameter in the form of a [token](../additional-api/signature/browser.md#setrequestedspreadsheet).                                    |
| options.url      | `string` | required | The absolute URL where the source data is stored. Be sure to add a [token](../get-started/how-it-works/security.md) when using local links. Otherwise, an error will occur. |
...
| options.token    | `string` | optional | The encrypted signature added to the parameter in the form of a [token](../additional-api/signature/browser.md#setrevisedfile).                                                 |
| options.url      | `string` | required | The absolute URL where the source document is stored. Be sure to add a [token](../get-started/how-it-works/security.md) when using local links. Otherwise, an error will occur. |
...
| Parameter           | Type             | Presence | Description                                                                                                                                                                                               |
| ------------------- | ---------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| options.c           | `string` | required | The operation type from the [onRequestUsers](./config/events.md#onrequestusers) event: `mention`, `protect`, or `info`. The default value is `mention`. |
