...
| Parameter                     | Type    | Presence | Description                                                                                                                                       |
| ----------------------------- | ------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| options.currentVersion        | `number` | required | Defines the current document version number.                                                                                                      |
| options.error                 | `string` | optional | Defines the error message text.                                                                                                                   |
| options.history               | `object[]` | required | Defines the array with the document versions.                                                                                                     |
...
| options.history.serverVersion | `number` | optional | Defines the current server version number. If the `changes` parameter is sent, then the `serverVersion` parameter is required to be sent as well. |
...
| options.history.version       | `number` | required | Defines the document version number.                                                                                                              |
...
| options.version           | `number` | required | Defines the document version number.                                                                                                                                                                                                                                                                             |
...
| options.users       | `object[]` | optional | Defines the list of the users.                                                                                                                                                                            |
