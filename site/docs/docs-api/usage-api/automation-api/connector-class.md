...
| *icons*    | string                                | The item icons (see the plugins [config](../../../plugins/fundamentals/configuration/configuration.md#variationsicons) documentation). |
...
| *icons*          | string \| object                            | The item icons (see the plugins [config](../../../plugins/fundamentals/configuration/configuration.md#variationsicons) documentation). |
