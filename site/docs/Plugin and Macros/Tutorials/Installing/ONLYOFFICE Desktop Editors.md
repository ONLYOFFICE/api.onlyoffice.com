...
**Step 4.** Start [ONLYOFFICE Desktop Editors](../../../Desktop%20Editors/Get%20Started/Overview.md). If everything is done correctly, the plugin will be displayed within the **Plugins** tab:
