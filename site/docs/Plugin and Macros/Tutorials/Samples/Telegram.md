...
You can also download this plugin from the [ONLYOFFICE App Directory](https://www.onlyoffice.com/en/app-directory/telegram) and install it following the [desktop](../Installing/ONLYOFFICE%20Desktop%20Editors.md) or [cloud](../Installing/ONLYOFFICE%20Cloud.md) installation instructions.
