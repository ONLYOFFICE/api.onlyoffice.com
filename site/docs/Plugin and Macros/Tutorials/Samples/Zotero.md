...
You can also download this plugin from the [ONLYOFFICE App Directory](https://www.onlyoffice.com/en/app-directory/zotero) and install it following the [desktop](../Installing/ONLYOFFICE%20Desktop%20Editors.md) installation instruction.
