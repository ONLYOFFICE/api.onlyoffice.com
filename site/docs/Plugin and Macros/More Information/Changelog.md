...
- Added the ability to download ready-to-use plugins from [ONLYOFFICE Plugin Marketplace](../Tutorials/Installing/ONLYOFFICE%20Desktop%20Editors.md#adding-plugins-through-the-plugin-manager) in ONLYOFFICE Desktop Editors.
...
- Added the [ONLYOFFICE Plugin Marketplace](../Tutorials/Installing/ONLYOFFICE%20Docs%20on-premises.md#adding-plugins-through-the-plugin-manager).
