...
- Added the [GetCurrentBookmark](../interacting-with-editors/methods/text-document-api/Api/Methods/GetCurrentBookmark.md) method to *window\.Asc.plugin.executeMethod* for Text document Api.
