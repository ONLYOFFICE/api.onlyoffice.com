...
| obj | object | The [config](../../../fundamentals/configuration/config-json.md) of the installed plugin. The version is taken from the config and compared with the current one to check for updates. |
