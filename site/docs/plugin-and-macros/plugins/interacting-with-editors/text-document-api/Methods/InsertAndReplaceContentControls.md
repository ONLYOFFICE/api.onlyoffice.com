...
Inserts the content control containing data. The data is specified by the JS code for [Document](../../../../../office-api/usage-api/text-document-api/text-document-api.md), or by a link to the shared document.
