...
The function called when a comment is added to the document with the [AddComment](../../../../../docs/plugin-and-macros/interacting-with-editors/document-api/Methods/AddComment.md) method.
