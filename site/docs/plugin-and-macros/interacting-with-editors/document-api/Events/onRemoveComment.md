...
The function called when the specified comment is removed with the [RemoveComments](../../../../../docs/plugin-and-macros/interacting-with-editors/document-api/Methods/RemoveComments.md) method.
