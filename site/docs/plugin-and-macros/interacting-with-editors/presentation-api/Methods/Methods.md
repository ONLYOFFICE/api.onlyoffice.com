...
| [GoToNextSlideInSlideShow](./GoToNextSlideInSlideShow.md) | None | Displays the slide following the current slide in the slide show. |
| [GoToPreviousSlideInSlideShow](./GoToPreviousSlideInSlideShow.md) | None | Displays the slide following the current slide in the slide show. |
| [GoToSlide](./GoToSlide.md) | None | Sets the active slide in the editor by its index. |
| [GoToSlideInSlideShow](./GoToSlideInSlideShow.md) | None | Displays the slide with the specific index. |
...
| [StartSlideShow](./StartSlideShow.md) | None | Starts the presentation slide show. |
