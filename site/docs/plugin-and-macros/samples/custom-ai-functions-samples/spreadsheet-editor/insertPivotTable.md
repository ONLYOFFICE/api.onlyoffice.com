...
<video className="light-video" controls style={{maxWidth: '848px'}}>
  <source src="/assets/images/plugins/functions-video/spreadsheets-editor/insertPivotTable.webm" type="video/webm" />
  Your browser does not support HTML5 video.
</video>
<video className="dark-video" controls style={{maxWidth: '848px'}}>
  <source src="/assets/images/plugins/functions-video/spreadsheets-editor/insertPivotTable.dark.webm" type="video/webm" />
  Your browser does not support HTML5 video.
</video>
