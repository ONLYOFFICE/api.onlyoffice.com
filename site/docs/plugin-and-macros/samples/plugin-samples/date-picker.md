...
Inserts a particular date it the spreadsheet. The format of the date can be selected from the available options.

**Plugin type:** visual, non-system.

**Supported Editors:** spreadsheets.

![DatePickerPlugin](/assets/images/plugins/date-picker.light.png#gh-light-mode-only)

![DatePickerPlugin](/assets/images/plugins/date-picker.dark.png#gh-dark-mode-only)
...
2. Navigate to the **Plugins** tab and select the Date Picker plugin.

3. Select the desired date and format. Click on the cell you want the date to be inserted in.

4. Click the **Insert Date** button.
...
- [onClick](/docs/plugin-and-macros/interacting-with-editors/form-api/Events/onClick.md)
