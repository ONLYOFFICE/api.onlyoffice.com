...
- onMethodReturn
- onTranslate
- [executeMethod ("GetFontList")](/site/docs/plugin-and-macros/interacting-with-editors/text-document-api/Methods/GetFontList.md)
