...
<video className="light-video" controls style={{maxWidth: '848px'}}>
  ...
  <source src="/assets/images/plugins/functions-video/presentation-editor/add-new-slide.webm" type="video/webm" />
  Your browser does not support HTML5 video.
</video>
<video className="dark-video" controls style={{maxWidth: '848px'}}>
  <source src="/assets/images/plugins/functions-video/presentation-editor/add-new-slide.dark.webm" type="video/webm" />
  Your browser does not support HTML5 video.
</video>
