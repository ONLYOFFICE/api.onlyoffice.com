...
| obj | object | The [config](../../../../../docs/plugins/configuration/configuration.md) of the installed plugin. The version is taken from the config and compared with the current one to check for updates. |
