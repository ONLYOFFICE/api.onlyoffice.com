...
in the ONLYOFFICE Document editor. Methods are run with executeMethod,
...
| [AddAddinField](./Methods/AddAddinField.md) | [AddinFieldData](./Enumeration/AddinFieldData.md) | Creates a new addin field with the data specified in the request. |
...
| [GetCurrentAddinField](./Methods/GetCurrentAddinField.md) | [AddinFieldData](./Enumeration/AddinFieldData.md) | Returns the current addin field from the document. |
...
| [MoveCursorOutsideField](./Methods/MoveCursorOutsideField.md) | None | Moves the cursor outside a field to the position before or after it. |
| [MoveCursorToAnnotationRange](./Methods/MoveCursorToAnnotationRange.md) | None | Moves the cursor to the beginning or end of the specified annotation range without selecting it. |
...
| [MoveCursorToField](./Methods/MoveCursorToField.md) | None | Moves the cursor to the beginning or end of a field. |
...
| [SelectAddinField](./Methods/SelectAddinField.md) | None | Selects the specified add-in field. |
| [SelectAnnotationRange](./Methods/SelectAnnotationRange.md) | None | Selects text in a document using a given annotation. |
...
| [SetRangeHtml](./Methods/SetRangeHtml.md) | None | Replaces a part of the specified paragraph with the content parsed from the given HTML string. |
...
| [onBlurAnnotation](./Events/onBlurAnnotation.md) | The function called when an annotation loses focus. |
| [onBlurContentControl](./Events/onBlurContentControl.md) | The function called to show which content control has been blurred. |
...
| [onChangeContentControl](./Events/onChangeContentControl.md) | The function called to show which content control has been changed. |
| [onChangeCurrentPage](./Events/onChangeCurrentPage.md) | The function called when the current page has changed. |
...
| [onClickAnnotation](./Events/onClickAnnotation.md) | The function called when the user clicks an annotation. |
...
| [onFocusAnnotation](./Events/onFocusAnnotation.md) | The function called when an annotation receives focus. |
| [onFocusContentControl](./Events/onFocusContentControl.md) | The function called to show which content control has been focused. |
| [onHideContentControlTrack](./Events/onHideContentControlTrack.md) | The function called when the content control loses focus in the document. |
| [onInsertOleObjects](./Events/onInsertOleObjects.md) | The function called when one or more OLE objects are inserted into the document. |
| [onParagraphText](./Events/onParagraphText.md) | The function called when the paragraph text is updated in the document. |
...
| [onShowContentControlTrack](./Events/onShowContentControlTrack.md) | The function called when the content control receives focus and its track appears. |
