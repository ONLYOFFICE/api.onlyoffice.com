...
Inserts the content control containing data. The data is specified by the JS code for [Document](../../../../../office-api/usage-api/document-api/), or by a link to the shared document.
