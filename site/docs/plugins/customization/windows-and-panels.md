...
1. In the [plugin code](../interacting-with-editors/overview/overview.md) file, specify the modal window / panel settings that are similar to [variations](../fundamentals/configuration/configuration.md#variations) in the plugin config.
   ...
   **Parameters**:
   ...
   | variations.type        | `string`   | "window"                                                                                                             | The plugin [type](../fundamentals/configuration/configuration.md#variationstype). Use the `"window"` value for modal windows, `"panel"` for left panels and `"panelRight"` for right panels.                                                                |
