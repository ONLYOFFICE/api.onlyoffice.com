...
1. Pack all the [plugin files](../../fundamentals/configuration/config-json.md) within the plugin folder into a **zip** archive and change its extension to `.plugin` (all the plugin files and subfolders must be at the archive root).
