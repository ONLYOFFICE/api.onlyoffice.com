...
3. Install a plugin [through the Plugin Manager](../installing-and-testing/desktop-editors-installation.md#option-1-plugin-manager-recommended).
   ...
   A plugin **GUID** will be used as the folder name. For example, `{07FD8DFA-DFE0-4089-A124-0730933CC80A}`.
