...
For more information about the plugin structure, see [configuration](../../../plugins/fundamentals/configuration/configuration.md).
...
All the config parameters are described in the [documentation](../../../plugins/fundamentals/configuration/configuration.md).
