...
But once you close the file (using the [CDocBuilder.CloseFile](../../builder-framework/CDocBuilder/CloseFile.md) method), all the variable data you worked with will be void and cleared, and you will not be able to use it with any other file.
