...
<Tabs groupId="lang">
    ...
    <TabItem value="cpp" label="C++">
        ```cpp
        int SaveFile(int nExtension, const wchar_t* sPath, const wchar_t* sParams = NULL);
        ```
    </TabItem>
...
<Tabs groupId="lang">
    <TabItem value="python" label="Python">
        ...
        | ------ | ----------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
        | type   | int \| str  |         | The file type as a hexadecimal integer ([OFFICESTUDIO\_FILE\_XXX](../../get-started/supported-formats.md) values) or a string (`docx`, `odt`, `rtf`, `txt`, `pptx`, `xlsx`, `ods`, `csv`, `pdf`). |
    ...
    <TabItem value="cpp" label="C++">
        | Name       | Type           | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
        | ---------- | -------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
        | nExtension | int            |         | The file type as a hexadecimal integer (see [OFFICESTUDIO\_FILE\_XXX](../../get-started/supported-formats.md) values). |
        | sPath      | const wchar_t* |         | The path to the file to be saved together with its name and extension.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
        | sParams    | const wchar_t* | NULL    | The parameters needed for the correct file saving (most commonly, the encoding is used for the `txt` and `csv` file types or the delimiter for the `csv` files, for other file types this is just an empty string). The parameters are added in the form of XML tags, where `m_nCsvTxtEncoding` is used for the text encoding and `m_nCsvDelimiter` is used for the `csv` delimiter. You can find all the supported values for the encoding [in this file](https://github.com/ONLYOFFICE/server/blob/master/Common/sources/commondefines.js). The supported values for the `csv` delimiters include: `0` - no delimiter; `1` - tab; `2` - semicolon; `3` - colon; `4` - comma; `5` - space. When saving into an image file (`png` or `jpg`) for creating thumbnails, the additional parameters are used. [See below](#saving-into-images) to find them out. |
    </TabItem>
    <TabItem value="com" label="COM">
    ...
    <TabItem value="java" label="Java">
        | Name   | Type          | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
        | ------ | ------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
        | type   | int \| String |         | The file type as a hexadecimal integer ([OFFICESTUDIO\_FILE\_XXX](../../get-started/supported-formats.md) values) or a string (`docx`, `odt`, `rtf`, `txt`, `pptx`, `xlsx`, `ods`, `csv`, `pdf`). |
    ...
    <TabItem value="net" label=".Net">
        | Name    | Type    | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
        | ------- | ------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
        | nType   | int     |         | The file type as a hexadecimal integer ([OFFICESTUDIO\_FILE\_XXX](../../get-started/supported-formats.md) values). |
    ...
    <TabItem value="js" label="JS">
        | Name   | Type   | Description                                                                                                                                     |
        | ------ | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
        | type   | String | The file extension: `docx`, `odt`, `rtf`, `txt`, `pptx`, `xlsx`, `ods`, `csv`, `pdf` (see [Supported formats](../../get-started/supported-formats.md)). |
        | path   | String | The path to the file to be saved together with its name and extension.                                                                          |
        | params | String | Optional. The parameters for file saving (encoding for `txt`/`csv`, delimiter for `csv`). See [Saving into images](#saving-into-images) for thumbnail parameters. |
    </TabItem>
</Tabs>
