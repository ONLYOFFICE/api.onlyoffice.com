...
11. After [10 seconds](../How%20It%20Works/Saving%20file.md#savedelay) of inactivity, ONLYOFFICE Docs sends a POST to *callbackUrl* letting HumHub know that the clients have finished editing the document and closed it.
