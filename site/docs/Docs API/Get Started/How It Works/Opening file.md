...
2. The document identifier and the link to it at the **document storage service** are sent using the [JavaScript API](../Basic%20concepts.md) to the **document editor**.
