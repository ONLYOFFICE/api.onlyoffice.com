...
This example demonstrates how to open the ONLYOFFICE editors via WKWebView using the editor configuration described in the [API documentation](../../Basic%20concepts.md) and the [configuration examples](../../Try%20Docs/Try%20Docs.md).
...
1. To track events and call appropriate methods, handle the [events](../../../Usage%20API/Config/Events.md) of ONLYOFFICE editors in native code by the **EditorEventsHandler** controller and then delegate them to **EditorViewController**:
