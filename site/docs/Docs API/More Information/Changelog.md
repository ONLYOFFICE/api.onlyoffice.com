...
- Added the [WOPISrc](../Using%20WOPI/Overview.md#wopisrc) query parameter to the requests from the browser to the server.
...
- Added the *key* field to the [document.referenceData](../Usage%20API/Config/Document/Document.md#referencedata) parameter.
...
- Added the [mobileView](../Using%20WOPI/WOPI%20discovery.md#wopi-actions) actions to the WOPI discovery.
