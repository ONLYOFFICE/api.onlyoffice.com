...
Further information about the language settings can be found [at this page](../../Usage%20API/Config/Editor/Editor.md).
...
Further information about these settings can be found [at this page](../../Usage%20API/Config/Document/Info.md).
