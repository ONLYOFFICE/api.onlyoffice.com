...
Macros are attached to a specific document and cannot be made global. If you need functionality available across all documents for all users, write a [plugin](../../plugins/get-started/overview.md) instead.
