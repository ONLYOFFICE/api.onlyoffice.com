...
- build [plugins](../../plugin-and-macros/plugins/interacting-with-editors/overview/overview.md) using Office API in the plugin code *.js* file to interact with the editor content and web services;
