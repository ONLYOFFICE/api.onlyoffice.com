...
- create a title page with a document heading and subtitle ([Api](/docs/office-api/usage-api/text-document-api/Api/Api.md), [ApiDocumentContent](/docs/office-api/usage-api/text-document-api/ApiDocumentContent/ApiDocumentContent.md), [ApiDrawing](/docs/office-api/usage-api/text-document-api/ApiDrawing/ApiDrawing.md));
- create different styles for the document text, heading, subtitle, table, footer ([ApiParaPr](/docs/office-api/usage-api/text-document-api/ApiParaPr/ApiParaPr.md), [ApiStyle](/docs/office-api/usage-api/text-document-api/ApiStyle/ApiStyle.md), [ApiTable](/docs/office-api/usage-api/text-document-api/ApiTable/ApiTable.md), [ApiTableCell](/docs/office-api/usage-api/text-document-api/ApiTableCell/ApiTableCell.md), [ApiTablePr](/docs/office-api/usage-api/text-document-api/ApiTablePr/ApiTablePr.md), [ApiTableRow](/docs/office-api/usage-api/text-document-api/ApiTableRow/ApiTableRow.md), [ApiTextPr](/docs/office-api/usage-api/text-document-api/ApiTextPr/ApiTextPr.md));
- structure the document by marking up its section: set columns for text and pictures, set page size and margins, create header and footer ([ApiDocument](/docs/office-api/usage-api/text-document-api/ApiDocument/ApiDocument.md), [ApiSection](/docs/office-api/usage-api/text-document-api/ApiSection/ApiSection.md));
- fill the document with text, dividing it into separate fragments and highlighting them with headings ([ApiParagraph](/docs/office-api/usage-api/text-document-api/ApiParagraph/ApiParagraph.md), [ApiRun](/docs/office-api/usage-api/text-document-api/ApiRun/ApiRun.md));
- add images and charts to represent document text ([Api](/docs/office-api/usage-api/text-document-api/Api/Api.md), [ApiChart](/docs/office-api/usage-api/text-document-api/ApiChart/ApiChart.md)).
