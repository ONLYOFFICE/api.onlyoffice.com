...
| arg7 | Optional | [ApiRange](../../ApiRange/ApiRange.md) \| [ApiName](../../ApiName/ApiName.md) \| boolean |  | Specifies whether to use straight-line depreciation when depreciation is greater than the declining balance calculation (-**false** or omitted).\nIf it is set to -**true**, the function uses the declining balance method. |
