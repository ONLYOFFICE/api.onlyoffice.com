...
| ---- | ---- | ----------- |
| ColorScaleCriteria | [ApiColorScaleCriterion](../ApiColorScaleCriterion/ApiColorScaleCriterion.md)[] | Returns the collection of criteria that define this color scale rule. |
...
| [GetType](./Methods/GetType.md) | [XlFormatConditionType](../Enumeration/XlFormatConditionType.md) | Returns the type of the color scale conditional formatting rule. |
