...
Check the class type returned by an ink annotation in a PDF document.

```javascript editor-pdf
// How do I check what type an ink annotation object is in a PDF document?

// Retrieve and output the class type string for an ink annotation in a PDF document.
