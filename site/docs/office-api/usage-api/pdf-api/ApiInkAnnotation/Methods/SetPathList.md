...
Set path list to ink annotation in a PDF document.

```javascript editor-pdf
// How to set path list for an ink annotation in a PDF document?

// Set path list and display the result in a PDF document.
