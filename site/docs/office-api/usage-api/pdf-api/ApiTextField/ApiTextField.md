...
| [GetCharLimit](./Methods/GetCharLimit.md) | number | Gets the text field character limit. |
...
| [IsComb](./Methods/IsComb.md) | boolean | Checks if the text field uses comb formatting. |
...
| [SetCharLimit](./Methods/SetCharLimit.md) | boolean | Sets the text field character limit. |
| [SetComb](./Methods/SetComb.md) | boolean | Sets whether the text field uses comb formatting. |
...
| [SetMask](./Methods/SetMask.md) | boolean | Sets the input mask for entered text. |
...
| [SetScrollLongText](./Methods/SetScrollLongText.md) | boolean | Sets whether the text field can scroll long text. |
