...
| [SetBehavior](./Methods/SetBehavior.md) | boolean | Sets button widget behavior. |
...
| [SetFitBounds](./Methods/SetFitBounds.md) | boolean | Sets button widget fit bounds. |
| [SetIconXPos](./Methods/SetIconXPos.md) | boolean | Sets button widget icon x position. |
| [SetIconYPos](./Methods/SetIconYPos.md) | boolean | Sets button widget icon y position. |
| [SetImage](./Methods/SetImage.md) | boolean | Sets image to button widget field. |
| [SetLabel](./Methods/SetLabel.md) | boolean | Sets label to button widget field. |
| [SetLayout](./Methods/SetLayout.md) | boolean | Sets button widget layout type |
