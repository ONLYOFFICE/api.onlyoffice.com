...
| [GetValue](./Methods/GetValue.md) | string | Returns the current image of the picture form as a base64 encoded string. |
...
| [SetValue](./Methods/SetValue.md) | boolean | Sets an image to the picture form. |
