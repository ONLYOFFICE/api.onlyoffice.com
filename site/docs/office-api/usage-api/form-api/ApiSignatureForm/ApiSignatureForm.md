...
ApiSignatureForm is a subclass of [ApiFormBase](../ApiFormBase/ApiFormBase.md).
...
| [GetClassType](./Methods/GetClassType.md) | "signatureForm" | Returns a type of the ApiSignatureForm class. |
...
| [GetValue](./Methods/GetValue.md) | string | Returns the current image of the signature form as a base64 encoded string. |
...
| [SetValue](./Methods/SetValue.md) | boolean | Sets an image to the signature form. |
