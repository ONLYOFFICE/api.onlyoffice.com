...
| [GetConditionalTableStyle](./Methods/GetConditionalTableStyle.md) | [ApiTableStylePr](../ApiTableStylePr/ApiTableStylePr.md) | Returns a set of formatting properties which will be conditionally applied to the parts of a table that match the  |
...
| [SetConditionalTableStyle](./Methods/SetConditionalTableStyle.md) | [ApiStyle](../ApiStyle/ApiStyle.md) | Sets conditional formatting properties that are applied to table parts matching the specified table style type. |
| [SetName](./Methods/SetName.md) | boolean | Sets a name of the current style. |
| [SetParaPr](./Methods/SetParaPr.md) | [ApiStyle](../ApiStyle/ApiStyle.md) | Sets the paragraph properties to the current style. |
| [SetTableCellPr](./Methods/SetTableCellPr.md) | [ApiStyle](../ApiStyle/ApiStyle.md) | Sets the table cell properties to the current style. |
| [SetTablePr](./Methods/SetTablePr.md) | [ApiStyle](../ApiStyle/ApiStyle.md) | Sets the table properties to the current style. |
| [SetTableRowPr](./Methods/SetTableRowPr.md) | [ApiStyle](../ApiStyle/ApiStyle.md) | Sets the table row properties to the current style. |
| [SetTextPr](./Methods/SetTextPr.md) | [ApiStyle](../ApiStyle/ApiStyle.md) | Sets the text properties to the current style. |
