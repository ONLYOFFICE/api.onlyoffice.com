...
- Added the [ApiFormatConditions] class to Spreadsheet API.
- Added the [ApiFormatConditions/Add] method to Spreadsheet API.
- Added the [ApiFormatConditions/AddAboveAverage] method to Spreadsheet API.
- Added the [ApiFormatConditions/AddColorScale] method to Spreadsheet API.
- Added the [ApiFormatConditions/AddDatabar] method to Spreadsheet API.
- Added the [ApiFormatConditions/AddIconSetCondition] method to Spreadsheet API.
- Added the [ApiFormatConditions/AddIconSetCondition] method to Spreadsheet API.
- Added the [ApiFormatConditions/AddTop10] method to Spreadsheet API.
- Added the [ApiFormatConditions/AddUniqueValues] method to Spreadsheet API.
- Added the [ApiFormatConditions/Delete] method to Spreadsheet API.
- Added the [ApiFormatConditions/GetCount] method to Spreadsheet API.
- Added the [ApiFormatConditions/GetParent] method to Spreadsheet API.
- Added the [ApiFormatConditions/GetItem] method to Spreadsheet API.
- Added the [ApiFormatConditions/ApiUniqueValues] method to Spreadsheet API.
- Added the [ApiFormatCondition] class to Spreadsheet API.
- Added the [ApiFormatCondition/Modify] method to Spreadsheet API.
- Added the [ApiFormatCondition/ModifyAppliesToRange] method to Spreadsheet API.
- Added the [ApiFormatCondition/SetFirstPriority] method to Spreadsheet API.
- Added the [ApiFormatCondition/SetLastPriority] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetAppliesTo] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetFont] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetType] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetFormula1] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetFormula2] method to Spreadsheet API.
- Added the [ApiFormatCondition/SetNumberFormat] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetNumberFormat] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetOperator] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetParent] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetType] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetPTCondition] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetPriority] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetScopeType] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetStopIfTrue] method to Spreadsheet API.
- Added the [ApiFormatCondition/SetStopIfTrue] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetText] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetTextOperator] method to Spreadsheet API.
- Added the [ApiFormatCondition/SetTextOperator] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetDateOperator] method to Spreadsheet API.
- Added the [ApiFormatCondition/SetDateOperator] method to Spreadsheet API.
- Added the [ApiFormatCondition/SetBorders] method to Spreadsheet API.
- Added the [ApiFormatCondition/SetFillColor] method to Spreadsheet API.
- Added the [ApiFormatCondition/GetFillColor] method to Spreadsheet API.
- Added the [ApiAboveAverage] class to Spreadsheet API.
- Added the [ApiAboveAverage/GetAboveBelow] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetAboveBelow] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetCalcFor] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetCalcFor] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetNumStdDev] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetNumStdDev] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetType] method to Spreadsheet API.
- Added the [ApiAboveAverage/Delete] method to Spreadsheet API.
- Added the [ApiAboveAverage/ModifyAppliesToRange] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetFirstPriority] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetLastPriority] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetAppliesTo] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetFont] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetInterior] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetNumberFormat] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetNumberFormat] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetParent] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetPriority] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetPriority] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetPTCondition] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetScopeType] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetScopeType] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetStopIfTrue] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetStopIfTrue] method to Spreadsheet API.
- Added the [ApiAboveAverage/SetFillColor] method to Spreadsheet API.
- Added the [ApiAboveAverage/GetFillColor] method to Spreadsheet API.
- Added the [ApiColorScale] class to the Spreadsheet API.
- Added the [ApiColorScale/GetType] method to Spreadsheet API.
- Added the [ApiColorScale/Delete] method to Spreadsheet API.
- Added the [ApiColorScale/ModifyAppliesToRange] method to Spreadsheet API.
- Added the [ApiColorScale/SetFirstPriority] method to Spreadsheet API.
- Added the [ApiColorScale/SetLastPriority] method to Spreadsheet API.
- Added the [ApiColorScale/GetAppliesTo] method to Spreadsheet API.
- Added the [ApiColorScale/GetParent] method to Spreadsheet API.
- Added the [ApiColorScale/GetPriority] method to Spreadsheet API.
- Added the [ApiColorScale/SetPriority] method to Spreadsheet API.
- Added the [ApiColorScale/GetPTCondition] method to Spreadsheet API.
- Added the [ApiColorScale/GetScopeType] method to Spreadsheet API.
- Added the [ApiColorScale/SetScopeType] method to Spreadsheet API.
- Added the [ApiColorScale/GetStopIfTrue] method to Spreadsheet API.
- Added the [ApiColorScale/SetStopIfTrue] method to Spreadsheet API.
- Added the [ApiColorScale/GetColorScaleCriteria] method to Spreadsheet API (returns an array of [ApiColorScaleCriterion]).
- Added the [ApiColorScaleCriterion] class to the Spreadsheet API.
- Added the [ApiColorScaleCriterion/GetType] method to Spreadsheet API.
- Added the [ApiColorScaleCriterion/SetType] method to Spreadsheet API.
- Added the [ApiColorScaleCriterion/GetValue] method to Spreadsheet API.
- Added the [ApiColorScaleCriterion/SetValue] method to Spreadsheet API.
- Added the [ApiColorScaleCriterion/GetIndex] method to Spreadsheet API.
- Added the [ApiColorScaleCriterion/GetColor] method to Spreadsheet API.
- Added the [ApiColorScaleCriterion/SetColor] method to Spreadsheet API.
- Added the [ApiDatabar] class to the Spreadsheet API.
- Added the [ApiDatabar/GetAxisColor] method to Spreadsheet API.
- Added the [ApiDatabar/SetAxisColor] method to Spreadsheet API.
- Added the [ApiDatabar/GetAxisPosition] method to Spreadsheet API.
- Added the [ApiDatabar/SetAxisPosition] method to Spreadsheet API.
- Added the [ApiDatabar/GetShowValue] method to Spreadsheet API.
- Added the [ApiDatabar/SetShowValue] method to Spreadsheet API.
- Added the [ApiDatabar/GetDirection] method to Spreadsheet API.
- Added the [ApiDatabar/SetDirection] method to Spreadsheet API.
- Added the [ApiDatabar/GetBarColor] method to Spreadsheet API.
- Added the [ApiDatabar/SetBarColor] method to Spreadsheet API.
- Added the [ApiDatabar/GetBarFillType] method to Spreadsheet API.
- Added the [ApiDatabar/SetBarFillType] method to Spreadsheet API.
- Added the [ApiDatabar/GetMinPointType] method to Spreadsheet API.
- Added the [ApiDatabar/SetMinPointType] method to Spreadsheet API.
- Added the [ApiDatabar/GetMinPointValue] method to Spreadsheet API.
- Added the [ApiDatabar/SetMinPointValue] method to Spreadsheet API.
- Added the [ApiDatabar/GetMaxPointType] method to Spreadsheet API.
- Added the [ApiDatabar/SetMaxPointType] method to Spreadsheet API.
- Added the [ApiDatabar/GetMaxPointValue] method to Spreadsheet API.
- Added the [ApiDatabar/SetMaxPointValue] method to Spreadsheet API.
- Added the [ApiDatabar/GetNegativeBarColor] method to Spreadsheet API.
- Added the [ApiDatabar/SetNegativeBarColor] method to Spreadsheet API.
- Added the [ApiDatabar/GetNegativeBorderColor] method to Spreadsheet API.
- Added the [ApiDatabar/SetNegativeBorderColor] method to Spreadsheet API.
- Added the [ApiDatabar/GetBarBorderColor] method to Spreadsheet API.
- Added the [ApiDatabar/SetBarBorderColor] method to Spreadsheet API.
- Added the [ApiDatabar/GetPercentMax] method to Spreadsheet API.
- Added the [ApiDatabar/SetPercentMax] method to Spreadsheet API.
- Added the [ApiDatabar/GetPercentMin] method to Spreadsheet API.
- Added the [ApiDatabar/SetPercentMin] method to Spreadsheet API.
- Added the [ApiDatabar/GetFormula] method to Spreadsheet API.
- Added the [ApiDatabar/GetType] method to Spreadsheet API.
- Added the [ApiDatabar/Delete] method to Spreadsheet API.
- Added the [ApiDatabar/ModifyAppliesToRange] method to Spreadsheet API.
- Added the [ApiDatabar/SetFirstPriority] method to Spreadsheet API.
- Added the [ApiDatabar/SetLastPriority] method to Spreadsheet API.
- Added the [ApiDatabar/GetAppliesTo] method to Spreadsheet API.
- Added the [ApiDatabar/GetParent] method to Spreadsheet API.
- Added the [ApiDatabar/GetPriority] method to Spreadsheet API.
- Added the [ApiDatabar/SetPriority] method to Spreadsheet API.
- Added the [ApiDatabar/GetPTCondition] method to Spreadsheet API.
- Added the [ApiDatabar/GetScopeType] method to Spreadsheet API.
- Added the [ApiDatabar/SetScopeType] method to Spreadsheet API.
- Added the [ApiDatabar/GetStopIfTrue] method to Spreadsheet API.
- Added the [ApiDatabar/SetStopIfTrue] method to Spreadsheet API.
- Added the [ApiIconSetCondition] class to the Spreadsheet API.
- Added the [ApiIconSetCondition/GetIconSet] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetIconSet] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetPercentileValues] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetPercentileValues] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetReverseOrder] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetReverseOrder] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetShowIconOnly] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetShowIconOnly] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetIconCriteria] method to Spreadsheet API (returns an array of [ApiIconCriterion]).
- Added the [ApiIconSetCondition/GetFormula] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetType] method to Spreadsheet API.
- Added the [ApiIconSetCondition/Delete] method to Spreadsheet API.
- Added the [ApiIconSetCondition/ModifyAppliesToRange] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetFirstPriority] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetLastPriority] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetAppliesTo] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetParent] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetPriority] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetPriority] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetPTCondition] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetScopeType] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetScopeType] method to Spreadsheet API.
- Added the [ApiIconSetCondition/GetStopIfTrue] method to Spreadsheet API.
- Added the [ApiIconSetCondition/SetStopIfTrue] method to Spreadsheet API.
- Added the [ApiIconCriterion] class to the Spreadsheet API.
- Added the [ApiIconCriterion/GetType] method to Spreadsheet API.
- Added the [ApiIconCriterion/SetType] method to Spreadsheet API.
- Added the [ApiIconCriterion/GetValue] method to Spreadsheet API.
- Added the [ApiIconCriterion/SetValue] method to Spreadsheet API.
- Added the [ApiIconCriterion/GetOperator] method to Spreadsheet API.
- Added the [ApiIconCriterion/SetOperator] method to Spreadsheet API.
- Added the [ApiIconCriterion/GetIndex] method to Spreadsheet API.
- Added the [ApiIconCriterion/GetIcon] method to Spreadsheet API.
- Added the [ApiIconCriterion/SetIcon] method to Spreadsheet API.
- Added the [ApiTop10] class to the Spreadsheet API.
- Added the [ApiTop10/GetCalcFor] method to Spreadsheet API.
- Added the [ApiTop10/SetCalcFor] method to Spreadsheet API.
- Added the [ApiTop10/GetTopBottom] method to Spreadsheet API.
- Added the [ApiTop10/SetTopBottom] method to Spreadsheet API.
- Added the [ApiTop10/GetPercent] method to Spreadsheet API.
- Added the [ApiTop10/SetPercent] method to Spreadsheet API.
- Added the [ApiTop10/GetRank] method to Spreadsheet API.
- Added the [ApiTop10/SetRank] method to Spreadsheet API.
- Added the [ApiTop10/GetType] method to Spreadsheet API.
- Added the [ApiTop10/Delete] method to Spreadsheet API.
- Added the [ApiTop10/ModifyAppliesToRange] method to Spreadsheet API.
- Added the [ApiTop10/SetFirstPriority] method to Spreadsheet API.
- Added the [ApiTop10/SetLastPriority] method to Spreadsheet API.
- Added the [ApiTop10/GetAppliesTo] method to Spreadsheet API.
- Added the [ApiTop10/GetParent] method to Spreadsheet API.
- Added the [ApiTop10/GetPriority] method to Spreadsheet API.
- Added the [ApiTop10/SetPriority] method to Spreadsheet API.
- Added the [ApiTop10/GetPTCondition] method to Spreadsheet API.
- Added the [ApiTop10/GetScopeType] method to Spreadsheet API.
- Added the [ApiTop10/SetScopeType] method to Spreadsheet API.
- Added the [ApiTop10/GetStopIfTrue] method to Spreadsheet API.
- Added the [ApiTop10/SetStopIfTrue] method to Spreadsheet API.
- Added the [ApiTop10/GetFont] method to Spreadsheet API.
- Added the [ApiTop10/GetNumberFormat] method to Spreadsheet API.
- Added the [ApiTop10/SetNumberFormat] method to Spreadsheet API.
- Added the [ApiTop10/GetFillColor] method to Spreadsheet API.
- Added the [ApiTop10/SetFillColor] method to Spreadsheet API.
- Added the [ApiUniqueValues] class to the Spreadsheet API.
- Added the [ApiUniqueValues/GetDupeUnique] method to Spreadsheet API.
- Added the [ApiUniqueValues/SetDupeUnique] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetType] method to Spreadsheet API.
- Added the [ApiUniqueValues/Delete] method to Spreadsheet API.
- Added the [ApiUniqueValues/ModifyAppliesToRange] method to Spreadsheet API.
- Added the [ApiUniqueValues/SetFirstPriority] method to Spreadsheet API.
- Added the [ApiUniqueValues/SetLastPriority] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetAppliesTo] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetParent] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetPriority] method to Spreadsheet API.
- Added the [ApiUniqueValues/SetPriority] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetPTCondition] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetScopeType] method to Spreadsheet API.
- Added the [ApiUniqueValues/SetScopeType] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetStopIfTrue] method to Spreadsheet API.
- Added the [ApiUniqueValues/SetStopIfTrue] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetFont] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetInterior] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetNumberFormat] method to Spreadsheet API.
- Added the [ApiUniqueValues/SetNumberFormat] method to Spreadsheet API.
- Added the [ApiUniqueValues/GetFillColor] method to Spreadsheet API.
- Added the [ApiUniqueValues/SetFillColor] method to Spreadsheet API.
...
- Added the *"comboBarLine"*, *"comboBarLineSecondary"*, *"comboCustom"*, and *"unknown"* available values for the [ChartType](../usage-api/text-document-api/Enumeration/ChartType.md) definition.
