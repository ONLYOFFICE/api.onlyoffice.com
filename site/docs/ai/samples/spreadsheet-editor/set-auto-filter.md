...
| criteria1       | string \| array \| object | ">18"            | The filter criteria. Can be: string for operators (e.g., ">10"), array for multiple values (e.g., \[1,2,3]), [ApiColor](../../../office-api/usage-api/spreadsheet-api/ApiColor) object for color filters, or dynamic filter constant. |
