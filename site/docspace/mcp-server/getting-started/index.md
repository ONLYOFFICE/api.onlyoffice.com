...
<DocCardList items={[
  ...
  {type: 'link', label: 'Connect to MCP clients', href: '/docspace/mcp-server/getting-started/clients', description: 'Connect mcp server to clients and start communicating with your DocSpace'},
]} />
...
- **Deploy anywhere** - The numerous [distribution formats](../distribution/index.md) available allows you to run in Docker, your existing Node.js environment, or as a standalone service - whatever fits your stack best.

## Use Cases

- **Project Management**: Set up different rooms and manage membership to these rooms based on access levels. Track who can access what files, and [archive rooms once they are completed](../tutorials/project-archival.md)
