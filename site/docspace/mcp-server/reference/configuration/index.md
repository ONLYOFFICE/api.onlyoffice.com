...
<DocCardList items={[
  ...
  {type: 'link', label: 'Request configuration', href: '/docspace/mcp-server/reference/configuration/request-configuration', description: 'Configure MCP server behavior using query parameters'},
]} />
