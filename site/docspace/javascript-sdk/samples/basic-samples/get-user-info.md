...
Create a script block to configure and initialize the SDK. Use the [getUserInfo()](../../usage-sdk/methods.md#getuserinfo) method to retrieve details about the current user.
