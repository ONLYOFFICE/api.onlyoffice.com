...
Create a script block to configure and initialize the SDK. Use the [getHashSettings()](/docspace/javascript-sdk/usage-sdk/methods.md#gethashsettings) method to retrieve current settings from the URL hash.
