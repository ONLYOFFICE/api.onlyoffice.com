...
- **Script testing**. Write and run JavaScript code using the DocSpace SDK to configure and initialize different embedding modes.
- **Live preview**. See the result of your configuration instantly in the embedded DocSpace frame.
