...
| onItemClick   | func                                                                                                       | `(id: string \| number) => {}`                                    | Defines a function that takes the folder/room id as an argument. Supports both string and number identifiers. This function can be asynchronous and can return `IMessage` or `Promise<void>`.                                                                                                                                                         |
