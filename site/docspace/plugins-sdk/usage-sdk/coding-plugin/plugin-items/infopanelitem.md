...
| submenu.onClick | func                                                                                                            | `() => {}`                                                        | A function that takes the file/folder/room id as an argument. This function can be asynchronous and can return `IMessage` or `Promise<void>`. It will be executed when clicking on the tab.                                                                                                              |
...
| onLoad          | func                                                                                                            | `() => {}`                                                        | Optional. Defines a function that is executed after opening a tab. It returns a new `body`. If this functionality is not needed, the old `body` value is returned.                                                                                                                                       |
