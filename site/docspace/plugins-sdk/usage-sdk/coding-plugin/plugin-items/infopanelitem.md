...
| submenu.onClick | func                                                                                                            | `() => {}`                                                        | A function that takes the file/folder/room id as an argument. This function can be asynchronous and can return `IMessage` or `Promise<IMessage>`. It will be executed when clicking on the tab.                                                                                                              |
| body            | [IBox](../plugin-components/box.md)                                                                             | `parentBox`                                                       | Defines the tab UI of the info panel.                                                                                                                                                                                                                                                                    |
| isHeaderVisible | boolean                                                                                                         | `false`                                                           | Specifies whether the header is visible in the info panel. By default, the header is visible.                                                                                                                                                                                                            |
| onLoad          | func                                                                                                            | `() => {}`                                                        | Optional. Defines a function that is executed after opening a tab. Returns `Promise<{ body: IBox }>` with the updated body. If this functionality is not needed, the old `body` value is returned.                                                                                                                                       |
