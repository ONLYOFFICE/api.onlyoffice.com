...
| security       | Defines the security parameters of the parent folder or room that will be checked. If all the parameters are **true**, the current item will be displayed in the context menu. If this parameter is undefined, it will be ignored.                                                                                    | array of [Security](https://github.com/ONLYOFFICE/docspace-plugin-sdk/blob/develop/src/enums/Security.ts)       | `[Security.Create]`                                               |
| withActiveItem | Specifies whether to add the action state to the item in the file list when the [onClick](#onClick) event is triggered.                                                                                                                                                                                               | boolean                                                                                                         | `true`                                                            |
