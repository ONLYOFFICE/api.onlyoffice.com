...
It requests file details using GET [/api/2.0/files/file/:fileId](/docspace/api-backend/usage-api/files/files/get-file-info).
...
If the status is recognized, the script moves the file into the corresponding folder using PUT [/api/2.0/files/fileops/move](/docspace/api-backend/usage-api/files/operations/move-batch-items).
