...
To initiate the OAuth 2.0 authorization flow, you can also send GET request to the [oauth2/authorize](../../../../../docspace/api-backend/usage-api/oauth-2-0/authorization/authorize-o-auth.md) address.
