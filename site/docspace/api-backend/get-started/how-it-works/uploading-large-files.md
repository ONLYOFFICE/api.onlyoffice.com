...
To upload files with size greater than 10 Mb (10 485 760 bytes), you need to create a session by sending the POST request to the following [endpoint](../../../../docspace/api-backend/usage-api/create-upload-session.md):
