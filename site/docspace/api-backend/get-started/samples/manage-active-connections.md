...
- Sends a GET request to [/api/2.0/security/activeconnections](../../../get-all-active-connections).
- Returns a list of active sessions on the portal.
...
## Step 2: Log out all sessions except the current one
- Sends a PUT request to [/api/2.0/security/activeconnections/logoutallexceptthis](../../../usage-api/log-out-all-except-this-connection).
- Terminates all sessions except the current API session.
...
- Sends a PUT request to [/api/2.0/security/activeconnections/logout/{id}](../../../usage-api/log-out-active-connection).
- Logs out a session by its login event ID.
...
## Step 4: Log out all sessions for a specific user
- Sends a PUT request to [/api/2.0/security/activeconnections/logoutall/{userId}](../../../usage-api/log-out-all-active-connections-for-user).
- Logs out all active sessions for the provided user ID.
