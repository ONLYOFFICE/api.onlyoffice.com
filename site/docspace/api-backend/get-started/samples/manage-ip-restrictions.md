...
- A PUT request is sent to [/api/2.0/settings/iprestrictions](../../../usage-api/save-ip-restrictions).
- Modifies the list of allowed IP addresses and enables/disables restrictions.
...
- A GET request is sent to [/api/2.0/settings/iprestrictions](../../../usage-api/get-ip-restrictions).
