...
- A PUT request is sent to [/api/2.0/people/:userid/contacts](../../../usage-api/update-member-contacts) with a list of contacts (e.g., email, phone)
...
## Step 2: Retrieve a user contacts
