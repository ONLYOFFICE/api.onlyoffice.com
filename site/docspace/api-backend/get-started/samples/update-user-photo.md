...
- A PUT request is sent to [/api/2.0/people/:userid/photo](../../../usage-api/update-member-photo) with `userid` and `photo url`
...
## Step 2: Delete user photo
- A DELETE request is sent to [/api/2.0/people/:userid/photo](../../../usage-api/delete-member-photo) with `userid`
