...
- A GET request is sent to [/api/2.0/group/:id](../../../usage-api/get-group) to fetch group details.
...
## Step 4: Delete a group
- A DELETE request is sent to [/api/2.0/group/:id](../../../usage-api/delete-group).
