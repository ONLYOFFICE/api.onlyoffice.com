...
- A GET request is sent to [/api/2.0/security/audit/login/last](../../../usage-api/get-last-login-events).
...
- A GET request is sent to [/api/2.0/security/audit/login/filter](../../../usage-api/get-login-events-by-filter).
- You can apply filters such as:
    - `userId`: filter by user ID
    - `action`: 0 = login, 1 = logout
    - `from, to`: date range in format YYYY-MM-DD
