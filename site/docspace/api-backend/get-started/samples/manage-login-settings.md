...
## Step 1: Update login settings
- A PUT request is sent to [/api/2.0/settings/security/loginsettings](../../../usage-api/update-login-settings) with:
...
- A GET request is sent to [/api/2.0/settings/security/loginsettings](../../../usage-api/get-login-settings).
...
- A DELETE request is sent to [/api/2.0/settings/security/loginsettings](../../../usage-api/set-default-login-settings).
- The API resets the login security settings to the default configuration.
- A GET request is sent to [/api/2.0/settings/security/loginsettings](../../../usage-api/get-login-settings) again to verify that the settings have been reset.
