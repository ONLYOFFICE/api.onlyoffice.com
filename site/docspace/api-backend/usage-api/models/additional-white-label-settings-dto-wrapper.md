...
|------------ | ------------- | ------------- | -------------|
| **response** | [**AdditionalWhiteLabelSettingsDto**](additional-white-label-settings-dto.md) | The AdditionalWhiteLabelSettingsDto object returned by the operation. | [optional] |
