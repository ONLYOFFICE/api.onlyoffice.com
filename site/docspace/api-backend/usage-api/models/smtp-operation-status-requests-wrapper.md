...
|------------ | ------------- | ------------- | -------------|
| **response** | [**SmtpOperationStatusRequestsDto**](smtp-operation-status-requests-dto.md) | The SmtpOperationStatusRequestsDto object returned by the operation. | [optional] |
