...
|------------ | ------------- | ------------- | -------------|
| **response** | [**CustomerServiceUsageReportDto**](customer-service-usage-report-dto.md) | The CustomerServiceUsageReportDto object returned by the operation. | [optional] |
