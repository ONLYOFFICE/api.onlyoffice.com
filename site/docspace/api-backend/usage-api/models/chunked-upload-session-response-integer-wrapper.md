...
|------------ | ------------- | ------------- | -------------|
| **response** | [**ChunkedUploadSessionResponseInteger**](chunked-upload-session-response-integer.md) | The ChunkedUploadSessionResponseInteger object returned by the operation. | [optional] |
