...
|------------ | ------------- | ------------- | -------------|
| **response** | [**ItemKeyValuePairBooleanString**](item-key-value-pair-boolean-string.md) | The ItemKeyValuePairBooleanString object returned by the operation. | [optional] |
