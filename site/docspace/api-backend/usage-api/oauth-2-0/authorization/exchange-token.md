...
|------------- | ------------- | ------------- | -------------|
| **200** | Successfully exchanged authorization code for access token | [**exchangeToken_200_response**](../../models/exchange-token-200-response.md) | - |
| **400** | Invalid request parameters | - | - |
| **401** | Client authentication failed: the client ID is unknown or the client secret does not match | - | - |

## Return type

[**exchangeToken_200_response**](../../models/exchange-token-200-response.md)
