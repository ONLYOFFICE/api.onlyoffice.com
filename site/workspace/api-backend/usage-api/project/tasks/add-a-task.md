...
**POST** `/api/2.0/project/{projectid:[0-9]+}/task`
...
Specifies whether to notify the responsibles about the task actions or not
...
Added task. A request that is not authenticated returns `401`.
