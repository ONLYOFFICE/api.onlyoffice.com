...
> Please note that it is not recommended to send a signature in the header when performing the HTTP requests to ONLYOFFICE Docs. Send the signature [in the body](../Token%20in%20body/index.md).
