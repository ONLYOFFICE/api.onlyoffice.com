...
1. Include the [Java wrapper](../../docs/document-builder/builder-framework/Java/Java.md) doctrenderer library:
...
- [Initialize](../../docs/document-builder/builder-framework/Java/CDocBuilder/initialize.md) the [DocBuilder](../../docs/document-builder/builder-framework/Java/CDocBuilder/CDocBuilder.md) with `docbuilder.jar` directory by passing an empty string:
...
- Open or create a file so that [Context](../../docs/document-builder/builder-framework/Java/CDocBuilderContext/CDocBuilderContext.md) and [Global](../../docs/document-builder/builder-framework/Java/CDocBuilderContext/getGlobal.md) classes can be accessed:
...
- Edit file using the Document Builder API methods. Use the [call](../../docs/document-builder/builder-framework/Java/CDocBuilderValue/call.md) method with the name and parameters of the API method you call as arguments:
...
- [Save](../../docs/document-builder/builder-framework/Java/CDocBuilder/saveFile.md) and [close](../../docs/document-builder/builder-framework/Java/CDocBuilder/closeFile.md) file after editing, then call the [dispose](../../docs/document-builder/builder-framework/Java/CDocBuilder/dispose.md) method to destroy DocBuilder:
