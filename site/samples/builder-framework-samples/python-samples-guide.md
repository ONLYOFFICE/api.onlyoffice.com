...
1. Include the [Python wrapper](../../docs/document-builder/builder-framework/Python/Python.md) doctrenderer library:
...
- Specify the [DocBuilder](../../docs/document-builder/builder-framework/Python/CDocBuilder/CDocBuilder.md):

  ```py
  builder = docbuilder.CDocBuilder()
  ```

- Open or create a file so that [Context](../../docs/document-builder/builder-framework/Python/CDocBuilderContext/CDocBuilderContext.md) and [Global](../../docs/document-builder/builder-framework/Python/CDocBuilderContext/GetGlobal.md) classes can be accessed:
...
- Edit file using Document Builder API methods. Use the [Call](../../docs/document-builder/builder-framework/Python/CDocBuilderValue/Call.md) method with the name and parameters of the API method you call as arguments:
...
- [Save](../../docs/document-builder/builder-framework/Python/CDocBuilder/SaveFile.md) and [close](../../docs/document-builder/builder-framework/Python/CDocBuilder/CloseFile.md) file after editing:
