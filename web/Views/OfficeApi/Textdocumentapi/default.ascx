...
<p>Thus any text document structure with <b>ONLYOFFICE Office API</b> used to create it can be outlined like this:</p>

<div class="document_structure">
        <p class="node_label"><b>ONLYOFFICE Office API</b></p>
